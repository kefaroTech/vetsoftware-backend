...
class JpaCompanyQueryPortTest {
    ...
    class Busqueda {
        ...
        void mapea_la_entidad_encontrada_a_su_companion_vo() {
            ...
            when(companyJpaRepository.findById(ProductCategoryMother.COMPANY_ID))
                    .thenReturn(Optional.of(companyEntity));

            Optional<CompanyRef> resultado = port.findById(ProductCategoryMother.COMPANY_ID);

            assertThat(resultado).contains(ProductCategoryMother.CLINICA);
        }
