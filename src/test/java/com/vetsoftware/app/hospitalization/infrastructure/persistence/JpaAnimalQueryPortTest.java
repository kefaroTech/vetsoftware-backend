...
/**
 * Adaptador de resolucion de animal para hospitalizaciones. Consulta SIEMPRE el
 * finder acotado por empresa — antes no lo hacia, y eso permitia ingresar un
 * paciente de mi empresa colgado del animal de la vecina.
 */
