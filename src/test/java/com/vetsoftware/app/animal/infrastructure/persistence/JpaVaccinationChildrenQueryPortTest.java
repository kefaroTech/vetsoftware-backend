...
class JpaVaccinationChildrenQueryPortTest {
    ...
    @Test
    @DisplayName("delega en existsByAnimal_Id cuando hay vacunas activas")
    void delega_cuando_hay_vacunas_activas() {
    ...
    @Test
    @DisplayName("delega en existsByAnimal_Id cuando no hay vacunas activas")
    void delega_cuando_no_hay_vacunas_activas() {
