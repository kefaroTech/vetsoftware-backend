...
class JpaDewormingChildrenQueryPortTest {
    ...
    @Test
    @DisplayName("delega en existsByAnimal_Id cuando hay desparasitaciones activas")
    ...
    @Test
    @DisplayName("delega en existsByAnimal_Id cuando no hay desparasitaciones activas")
