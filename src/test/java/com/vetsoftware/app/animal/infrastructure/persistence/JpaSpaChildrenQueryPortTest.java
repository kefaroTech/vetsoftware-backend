...
@DisplayName("JpaSpaChildrenQueryPort")
class JpaSpaChildrenQueryPortTest {

    @Mock
    private SpaJpaRepository jpaRepository;
    @InjectMocks
    private JpaSpaChildrenQueryPort port;

    @Test
    @DisplayName("delega en existsByAnimal_Id cuando hay servicios de spa activos")
    void delega_cuando_hay_servicios_activos() {
    ...
    @Test
    @DisplayName("delega en existsByAnimal_Id cuando no hay servicios de spa activos")
    void delega_cuando_no_hay_servicios_activos() {
