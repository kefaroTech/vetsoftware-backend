...
@DisplayName("JpaCompanyQueryPort (purchaseorder)")
class JpaCompanyQueryPortTest {
    ...
    class FindById {
        ...
        void mapea_la_empresa_encontrada() {
            ...
            when(entidad.getName()).thenReturn("Clinica Veterinaria");
            ...
            assertThat(ref)
                    .contains(new CompanyRef(COMPANY_ID, "Clinica Veterinaria", "900123456"));
        }
