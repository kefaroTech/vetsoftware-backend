...
@DisplayName("JpaProductQueryPort (purchaseorder)")
class JpaProductQueryPortTest {
    ...
    class FindById {
        ...
        void mapea_el_producto_encontrado() {
            ...
            when(entidad.getCode()).thenReturn("VAC-001");
            ...
            assertThat(ref).contains(new ProductRef(PRODUCT_ID, "Vacuna Triple", "VAC-001"));
        }
