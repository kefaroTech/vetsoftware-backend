...
@DisplayName("JpaSupplierQueryPort (purchaseorder)")
class JpaSupplierQueryPortTest {
    ...
    class FindById {
        ...
        void mapea_el_proveedor_encontrado() {
            ...
            when(entidad.getName()).thenReturn("Distribuidora Animal");
            ...
            assertThat(ref).contains(new SupplierRef(SUPPLIER_ID, "Distribuidora Animal"));
        }
