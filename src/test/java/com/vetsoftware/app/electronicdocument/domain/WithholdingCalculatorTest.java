...
class WithholdingCalculatorTest {
  ...
  /**
   * UVT 2026 usado como referencia en los escenarios; el cálculo no depende del año, solo del
   * valor.
   */
  ...
  class UvtNoDisponible {
    ...
    void sin_uvt_no_se_bloquea_la_retencion() {
      // Política documentada: si no hay UVT configurado no se puede evaluar el mínimo → no se
      // bloquea.
      WithholdingAmounts sinUvt =
          WithholdingCalculator.compute(
