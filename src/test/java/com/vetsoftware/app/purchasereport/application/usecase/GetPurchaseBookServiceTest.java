...
/** Test del libro de compras: agrega las facturas del periodo y calcula los totales. */
class GetPurchaseBookServiceTest {

    private static PurchaseDocumentQueryPort.PurchaseDocumentView view(
            long id, String base, String tax, String with, String total, String paid, String balance) {
        return new PurchaseDocumentQueryPort.PurchaseDocumentView(
            id, "Distribuidora", "800111222-3", "FV-" + id,
    ...
    void agrega_entradas_y_totaliza_el_periodo() {
        ...
        PurchaseBookDto book = service.get(1L, LocalDate.of(2026, 7, 1), LocalDate.of(2026, 7, 31), null);
