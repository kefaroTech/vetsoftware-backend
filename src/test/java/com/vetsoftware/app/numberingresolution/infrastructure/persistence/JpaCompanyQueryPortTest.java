...
@DisplayName("JpaCompanyQueryPort (numberingresolution)")
class JpaCompanyQueryPortTest {
    ...
    class FindById {
        ...
        void mapea_la_empresa_encontrada() {
            ...
            when(entidad.getName()).thenReturn("Veterinaria Central");
            ...
            assertThat(ref)
                    .contains(new CompanyRef(COMPANY_ID, "Veterinaria Central", "900123456"));
        }
