...
/**
 * Adapter de resolución de sede para cuentas abiertas. Espeja al de citas: filtro {@code
 * isActive()} en el camino explícito y cascada Principal-activa→primera-activa en el camino por
 * defecto. Verifica que una sede inactiva no se abra como cuenta.
 */
