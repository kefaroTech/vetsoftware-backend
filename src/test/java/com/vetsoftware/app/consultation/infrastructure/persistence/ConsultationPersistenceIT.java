...
class ConsultationPersistenceIT extends AbstractDataJpaTest {
    ...
    class BajaYReactivacion {
        ...
        @Test
        @DisplayName("delete aplica el soft delete acotado por empresa")
        void delete_aplica_el_soft_delete_acotado_por_empresa() {
            Long id = guardar(FIRULAIS, CLINICA);
        ...
        @Test
        @DisplayName("delete de una consulta de otra empresa no borra nada")
        void delete_de_otra_empresa_no_borra_nada() {
            Long id = guardar(FIRULAIS, CLINICA);

            repository.delete(id, OTRA_EMPRESA);
            entityManager.flush();
            entityManager.clear();
        ...
        @Test
        @DisplayName("reactivate de otra empresa no afecta filas")
        void reactivate_de_otra_empresa_no_afecta_filas() {
            ...
            assertThat(repository.reactivate(id, OTRA_EMPRESA)).isZero();
        }
    }
}
