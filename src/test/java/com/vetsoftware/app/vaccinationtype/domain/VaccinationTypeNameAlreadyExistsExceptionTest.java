 ...
 */
@DisplayName("VaccinationTypeNameAlreadyExistsException")
class VaccinationTypeNameAlreadyExistsExceptionTest {

    @Test
    @DisplayName("el mensaje incluye el nombre repetido")
    void el_mensaje_incluye_el_nombre_repetido() {
        VaccinationTypeNameAlreadyExistsException ex = new VaccinationTypeNameAlreadyExistsException(
                "Rabia");

        assertThat(ex.getMessage()).contains("Rabia");
    }
    ...
    void el_mensaje_esta_en_espanol_y_nombra_el_ambito() {
        ...
        assertThat(ex.getMessage()).contains("tipo de vacuna").contains("este ámbito");
    }
}
