...
class BusinessGaugeMetricsTest {
  ...
  void refreshesCachedBacklogAndInventoryValues() {
    ...
    assertThat(
            registry
                .get(BusinessMetricNames.DIAN_BACKLOG)
                .tags("status", "pending", "age", "lt_15m")
                .gauge()
                .value())
        .isEqualTo(2);
    assertThat(
            registry
                .get(BusinessMetricNames.DIAN_BACKLOG)
                .tags("status", "pending", "age", "from_15m_to_1h")
                .gauge()
                .value())
        .isEqualTo(3);
    assertThat(
    ...
    assertThat(
            registry
                .get(BusinessMetricNames.INVENTORY_EXPIRING_LOTS)
                .tag("age", "expired")
                .gauge()
                .value())
        .isEqualTo(6);
