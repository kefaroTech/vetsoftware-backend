 ...
 * <b>real</b>: {@link RedactingAppender} envolviendo un appender destino, igual que en {@code
 * logback-spring.xml}.
 *
 * <p>El valor señuelo se inyecta por las cuatro superficies posibles (mensaje formateado, MDC,
 * pares clave-valor y cadena de excepciones) y se afirma que no sobrevive en <em>ninguna</em> de
 * ellas en el evento que recibe el appender destino — que es exactamente lo que se serializa a
 * Loki.
 */
