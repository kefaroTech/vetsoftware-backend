...
class RemoteConnectionValidatorTest {
    ...
    void acceptsOnlyRemoteDependencies() {
        ...
        assertThatCode(() -> validator.postProcessBeanFactory(
                mock(ConfigurableListableBeanFactory.class))).doesNotThrowAnyException();
    }
