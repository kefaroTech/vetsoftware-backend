...
@DisplayName("EntitlementOwnerUsageLimitAdapter")
class EntitlementOwnerUsageLimitAdapterTest {
    ...
    private EntitlementOwnerUsageLimitAdapter adapter;

    private void crearAdaptador() {
        adapter = new EntitlementOwnerUsageLimitAdapter(checkUsageLimit, recordUsageEvent,
                systemAuthRunner);
    }
    ...
    class Comprobacion {
        ...
        @Test
        @DisplayName("consulta el eje OWNER sin reinicio de periodo (ALLTIME)")
        void consulta_el_eje_owner_sin_reinicio() {
            crearAdaptador();
            ...
            assertThat(captor.getValue())
                    .isEqualTo(new CheckUsageLimitCommand(COMPANY_ID, "OWNER", "ALLTIME"));
    ...
    class Registro {
        ...
        @Test
        @DisplayName("anota el hecho bajo SystemAuthRunner, con el id del propietario ya creado")
        void anota_el_hecho_bajo_system_auth_runner() {
            ...
            adapter.record(COMPANY_ID, OWNER_ID, OCCURRED_AT);
            ...
            assertThat(captor.getValue()).isEqualTo(new RecordCompanyUsageEventCommand(COMPANY_ID,
                    "OWNER", OWNER_ID, OCCURRED_AT, "ALLTIME", false, null));
        }
