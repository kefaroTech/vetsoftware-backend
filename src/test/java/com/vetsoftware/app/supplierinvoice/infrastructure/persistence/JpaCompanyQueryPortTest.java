...
@DisplayName("JpaCompanyQueryPort (supplierinvoice)")
class JpaCompanyQueryPortTest {
    ...
    class FindById {
        ...
        void mapea_la_empresa_encontrada() {
            ...
            when(entidad.getIdentifier()).thenReturn("NIT-900");
            ...
            assertThat(ref).contains(new CompanyRef(COMPANY_ID, "Clinica Norte", "NIT-900"));
        }
