...
@DisplayName("EntitlementSpaUsageLimitAdapter")
class EntitlementSpaUsageLimitAdapterTest {

    private static final Long COMPANY_ID = 9L;
    private static final Long SPA_ID = 400L;
    ...
    private EntitlementSpaUsageLimitAdapter adapter;

    private void crearAdaptador() {
        adapter = new EntitlementSpaUsageLimitAdapter(checkUsageLimit, recordUsageEvent,
    ...
    class Registro {
        ...
        @Test
        @DisplayName("anota el hecho con origen SPA, bajo SystemAuthRunner")
        void anota_el_hecho_con_origen_spa() {
            crearAdaptador();
            doAnswer(inv -> {
            ...
            adapter.record(COMPANY_ID, SPA_ID, OCCURRED_AT);
            ...
            assertThat(captor.getValue()).isEqualTo(new RecordCompanyUsageEventCommand(COMPANY_ID,
                    "GROOMING_SERVICE", SPA_ID, OCCURRED_AT, "2026-03", false, "SPA"));
        }
    }
}
