...
public class JpaSurgeryRepository implements SurgeryRepository {
  ...
  public JpaSurgeryRepository(
      SurgeryJpaRepository jpaRepository,
  ...
  public Surgery save(Surgery surgery) {
    SurgeryTypeJpaEntity surgeryType =
        surgeryTypeJpaRepository.getReferenceById(surgery.getSurgeryType().id());
    ...
    SurgeryJpaEntity saved =
        jpaRepository.save(mapper.toJpa(surgery, surgeryType, animal, consultation, company));
    return mapper.toDomain(
        saved,
        surgery.getSurgeryType(),
        surgery.getAnimal(),
        surgery.getConsultation(),
        surgery.getCompany());
  }
