...
public class Surgery {
    ...
    public Surgery(Long id, LocalDate date, SurgeryTypeRef surgeryType, String description,
            String medicament, String observations, String complications, SurgeryStatus status,
            AnimalRef animal, ConsultationRef consultation, CompanyRef company,
            LocalDateTime createdDate, boolean enabled) {
        validate(date, surgeryType, description, medicament, observations, complications, status,
                animal, company);
        this.id = id;
        this.date = date;
    ...
    public static Surgery create(LocalDate date, SurgeryTypeRef surgeryType, String description,
            String medicament, String observations, String complications, AnimalRef animal,
    ...
    private static void validate(LocalDate date, SurgeryTypeRef surgeryType, String description,
        ...
        if (surgeryType == null)
            throw new IllegalArgumentException("surgeryType is required");
    ...
    public SurgeryTypeRef getSurgeryType() {
        return surgeryType;
    }
