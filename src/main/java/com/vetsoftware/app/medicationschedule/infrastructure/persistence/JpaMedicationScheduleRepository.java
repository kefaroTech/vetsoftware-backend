...
public class JpaMedicationScheduleRepository implements MedicationScheduleRepository {
  ...
  public JpaMedicationScheduleRepository(
      MedicationScheduleJpaRepository jpaRepository,
  ...
  public MedicationSchedule save(MedicationSchedule medicationSchedule) {
    HospitalizationMedicationJpaEntity hospitalizationMedication =
        hospitalizationMedicationJpaRepository.getReferenceById(
            medicationSchedule.getHospitalizationMedication().id());
    ...
    return mapper.toDomain(
        saved,
        medicationSchedule.getHospitalizationMedication(),
  ...
  public List<MedicationSchedule> findByHospitalizationId(Long hospitalizationId) {
    return jpaRepository
        .findByHospitalizationMedicationHospitalizationId(hospitalizationId)
        .stream()
        .map(mapper::toDomain)
        .toList();
  }
