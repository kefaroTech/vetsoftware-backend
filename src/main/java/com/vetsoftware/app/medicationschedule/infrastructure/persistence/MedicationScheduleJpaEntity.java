...
@SQLDelete(sql = "UPDATE medication_schedules SET enabled = false WHERE id = ?")
...
public class MedicationScheduleJpaEntity {
    ...
    public HospitalizationMedicationJpaEntity getHospitalizationMedication() { return hospitalizationMedication; }
    public void setHospitalizationMedication(HospitalizationMedicationJpaEntity hospitalizationMedication) { this.hospitalizationMedication = hospitalizationMedication; }
