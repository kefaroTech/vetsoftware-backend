...
public class MedicationScheduleJpaMapper {
  ...
  public MedicationScheduleJpaEntity toJpa(
    ...
    entity.setAppliedStatus(
        medicationSchedule.getAppliedStatus() != null
