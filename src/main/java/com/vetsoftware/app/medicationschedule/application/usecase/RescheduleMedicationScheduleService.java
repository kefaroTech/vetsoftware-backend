...
public class RescheduleMedicationScheduleService implements RescheduleMedicationScheduleUseCase {
  ...
  public RescheduleMedicationScheduleService(
  ...
  public List<MedicationScheduleDto> execute(RescheduleMedicationScheduleCommand command) {
    ...
    List<MedicationSchedule> all =
        new ArrayList<>(repository.findByHospitalizationMedicationId(medicationId));
  ...
  private void recalcFollowing(
      List<MedicationSchedule> all, int pivotIdx, LocalDateTime from, int intervalHours) {
