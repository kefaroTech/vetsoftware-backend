...
/**
 * Datos de la orden de medicación que la generación del calendario necesita. Companion VO propio de
 * la feature (los enums llegan como String para no acoplar con el dominio de
 * hospitalizationmedication — vertical slicing).
 */
