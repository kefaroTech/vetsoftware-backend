...
public class OpenAccountJpaMapper {
  ...
  public OpenAccountJpaEntity toJpa(
  ...
  public OpenAccount toDomain(OpenAccountJpaEntity entity) {
    ...
    EmployeeRef closedByRef =
        closedBy != null ? new EmployeeRef(closedBy.getId(), closedBy.getName()) : null;
    return toDomain(
        entity,
  ...
  public OpenAccount toDomain(
      OpenAccountJpaEntity entity,
      OwnerRef ownerRef,
