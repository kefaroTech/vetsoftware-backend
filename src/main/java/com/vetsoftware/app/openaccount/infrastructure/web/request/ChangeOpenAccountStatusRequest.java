...
public record ChangeOpenAccountStatusRequest(
        @NotBlank(message = "Debes seleccionar el estado de la cuenta.") String status,
        // Opcional a nivel HTTP: la obligatoriedad del motivo en CANCEL la enforza el
        // dominio.
        String reason,
        // Solo se usan al cerrar (CLOSE): tipo de documento a auto-emitir
        // ("DOC_EQUIV_POS" |
        // "FE_VENTA";
