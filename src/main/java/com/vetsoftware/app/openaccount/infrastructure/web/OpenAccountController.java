...
public class OpenAccountController {
  ...
  public OpenAccountController(
      CreateOpenAccountUseCase createUseCase,
  ...
  public PageResponse<OpenAccountResponse> search(
    ...
    PageResult<OpenAccountDto> result =
        searchUseCase.execute(
            new SearchOpenAccountsCommand(
  ...
  @PutMapping("/{id}")
  public OpenAccountResponse update(
      @PathVariable Long id, @Valid @RequestBody UpdateOpenAccountRequest request) {
    return toResponse(
        updateUseCase.execute(
            new UpdateOpenAccountCommand(
                id, request.ownerId(), authz.currentCompanyId(), request.expectedVersion())));
  }
  ...
  public OpenAccountResponse changeStatus(
      @PathVariable Long id, @Valid @RequestBody ChangeOpenAccountStatusRequest request) {
    return toResponse(
        changeStatusUseCase.execute(
            new ChangeOpenAccountStatusCommand(
                id,
                request.status(),
