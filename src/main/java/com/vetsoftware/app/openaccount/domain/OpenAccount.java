...
public class OpenAccount {
  ...
  public static OpenAccount create(
      OwnerRef owner, CompanyRef company, BranchRef branch, EmployeeRef createdBy) {
  ...
  /**
   * Cambia el estado de la cuenta. Reglas de negocio: - Solo desde OPEN (CLOSE y CANCEL son
   * terminales). - Solo hacia CLOSE o CANCEL. - CANCEL exige motivo (anulación/incobrable =
   * pérdida, debe justificarse). CLOSE no. Registra quién, cuándo y por qué (trazabilidad
   * contable).
   */
