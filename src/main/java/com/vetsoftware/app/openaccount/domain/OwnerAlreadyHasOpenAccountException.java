...
/**
 * Regla de negocio: un propietario solo puede tener UNA cuenta abierta a la vez. Se lanza al
 * intentar abrir una cuenta para un propietario que ya tiene una activa.
 */
