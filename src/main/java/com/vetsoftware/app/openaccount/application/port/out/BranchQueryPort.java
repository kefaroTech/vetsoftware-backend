...
/**
 * Resuelve la sucursal de una cuenta abierta. Si el request trae {@code branchId} se valida contra la
 * empresa; si no, se usa la sede por defecto ("Principal"). Empresas de una sola sede funcionan sin enviarlo.
 */
