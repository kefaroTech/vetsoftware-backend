...
public record ChangeOpenAccountStatusCommand(
    ...
    // "DOC_EQUIV_POS" (venta de mostrador) o "FE_VENTA" (factura); null → DOC_EQUIV_POS por
    // defecto.
    String documentType,
    boolean finalConsumer,
    // Versión esperada de la cuenta (opt-in): si se envía y no coincide con la actual, se rechaza
