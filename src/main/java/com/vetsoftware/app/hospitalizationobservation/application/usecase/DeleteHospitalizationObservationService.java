...
@Observed(name = "hospitalization_observation.delete")
@Service
public class DeleteHospitalizationObservationService implements DeleteHospitalizationObservationUseCase {
