...
public class JpaSurgeryTypeRepository implements SurgeryTypeRepository {
    ...
    @Override
    public Optional<SurgeryType> findOwnedByIdAndCompanyId(Long id, Long companyId) {
    ...
    @Override
    public Optional<SurgeryType> findByNameAndCompanyIdIncludingDisabled(String name,
            Long companyId) {
