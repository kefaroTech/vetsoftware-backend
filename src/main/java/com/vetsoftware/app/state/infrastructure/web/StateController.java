...
public class StateController {
  ...
  public StateController(
      CreateStateUseCase createUseCase,
      UpdateStateUseCase updateUseCase,
      FindStateUseCase findUseCase,
      ListStatesUseCase listUseCase,
  ...
  public List<StateResponse> listByCountry(@PathVariable Long countryId) {
    return listByCountryUseCase.listByCountry(countryId).stream().map(this::toResponse).toList();
  }
  ...
  public StateResponse update(
      @PathVariable Long id, @Valid @RequestBody UpdateStateRequest request) {
    return toResponse(
