...
public class SubModuleController {
    ...
    public SubModuleResponse create(@RequestBody CreateSubModuleRequest request,
    ...
    @PutMapping("/{id}")
    public SubModuleResponse update(@PathVariable Long id, @RequestBody UpdateSubModuleRequest request,
                                    @RequestAttribute AuthContext authContext) {
