...
public class SubModuleController {
  ...
  public SubModuleController(
      CreateSubModuleUseCase createUseCase,
      UpdateSubModuleUseCase updateUseCase,
      FindSubModuleUseCase findUseCase,
      ListSubModulesUseCase listUseCase,
  ...
  @PutMapping("/{id}")
  public SubModuleResponse update(
      @PathVariable Long id, @Valid @RequestBody UpdateSubModuleRequest request) {
    return toResponse(
