...
/**
 * Alineado con sus hermanos —{@code CreateSubModuleUseCase},
 * {@code UpdateSubModuleUseCase}, {@code DeleteSubModuleUseCase} y
 * {@code FindSubModuleUseCase} son {@code hasRole('SYSTEM')} a secas—, que es
 * lo que este puerto debio ser siempre: llevaba
 * {@code hasAuthority('submodule.update')} por copia del patron CRUD del
