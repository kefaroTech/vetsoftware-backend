...
public class CashTerminalService {
  ...
  public CashTerminalService(
      CashTerminalJpaRepository repository,
  ...
  public List<CashTerminalDto> list(Long companyId, Long branchId, boolean activeOnly) {
    ...
    List<CashTerminalJpaEntity> terminals =
        activeOnly
            ? repository.findAllByCompanyIdAndBranchIdAndActiveTrueOrderByNameAsc(
                companyId, branchId)
  ...
  public CashTerminalDto create(Long companyId, Long branchId, String name, String code) {
    ...
    if (repository.existsByCompanyIdAndBranchIdAndCodeIgnoreCase(
        companyId, branchId, normalizedCode)) {
  ...
  public CashTerminalDto update(Long companyId, Long id, String name, String code) {
    ...
    if (!entity.getCode().equalsIgnoreCase(normalizedCode)
        && cashSessionRepository.existsOpenByTerminalId(
            companyId, entity.getBranchId(), entity.getId())) {
