...
public interface CashTerminalJpaRepository extends JpaRepository<CashTerminalJpaEntity, Long> {
    List<CashTerminalJpaEntity> findAllByCompanyIdAndBranchIdOrderByActiveDescNameAsc(Long companyId, Long branchId);
    List<CashTerminalJpaEntity> findAllByCompanyIdAndBranchIdAndActiveTrueOrderByNameAsc(Long companyId, Long branchId);
