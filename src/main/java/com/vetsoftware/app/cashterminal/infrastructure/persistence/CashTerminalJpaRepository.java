...
public interface CashTerminalJpaRepository extends JpaRepository<CashTerminalJpaEntity, Long> {
    ...
    Optional<CashTerminalJpaEntity> findByIdAndCompanyIdAndBranchIdAndActiveTrue(Long id,
            Long companyId, Long branchId);

    boolean existsByCompanyIdAndBranchIdAndCodeIgnoreCase(Long companyId, Long branchId,
            String code);

    boolean existsByCompanyIdAndBranchIdAndCodeIgnoreCaseAndIdNot(Long companyId, Long branchId,
            String code, Long id);
}
