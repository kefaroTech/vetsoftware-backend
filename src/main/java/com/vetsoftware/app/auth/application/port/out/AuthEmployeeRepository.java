...
public interface AuthEmployeeRepository {
    ...
    /**
     * Incrementa la versión bajo bloqueo de fila y devuelve el estado autenticable actualizado.
     * Serializa logins concurrentes para que solo la última versión emitida permanezca válida.
     */
