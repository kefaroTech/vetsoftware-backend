...
public class RefreshAccessTokenService implements RefreshTokenUseCase {
  ...
  public TokenDto execute(String rawRefreshToken) {
    ...
    StoredRefreshToken stored =
        refreshTokenRepository.findByHash(hash).orElseThrow(InvalidCredentialsException::new);
    ...
    String newRefreshToken =
        refreshTokenIssuer.issue(stored.subjectId(), stored.subjectType(), stored.authVersion());
