 ...
 * sin acceso a recursos scopeados a sede. Todos los empleados, incluido el rol empresarial {@code ADMIN}, se
 * autorizan exclusivamente mediante permisos granulares y alcance tenant.</p>
 */
