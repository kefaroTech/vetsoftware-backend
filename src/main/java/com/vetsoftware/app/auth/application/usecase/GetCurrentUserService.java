...
public class GetCurrentUserService implements GetCurrentUserUseCase {
  ...
  public GetCurrentUserService(
      EmployeeProfileQueryPort employeeProfileQueryPort,
  ...
  public MeDto execute() {
    ...
    if (principal instanceof EmployeeContext me) {
      EmployeeProfile profile =
          employeeProfileQueryPort
              .findById(me.employeeId())
    ...
    if (principal instanceof SystemUserContext me) {
      SystemUserProfile profile =
          systemUserProfileQueryPort
              .findById(me.systemUserId())
