...
/**
 * Reporte de cuentas por pagar por antigüedad (aging). Agrupa el saldo pendiente de las facturas no
 * pagadas por proveedor y por tramo de días vencidos respecto a {@code asOf}: al día (no vencido),
 * 1–30, 31–60, 61–90 y +90.
 */
public record AccountsPayableAgingDto(LocalDate asOf, List<SupplierRow> suppliers, Bucket totals) {
