...
/** Companion VO: empresa (feature {@code company}) dueña de la factura de proveedor. */
public record CompanyRef(Long id, String name, String identifier) {
    public CompanyRef {
        ...
        if (identifier == null || identifier.isBlank()) throw new IllegalArgumentException("company identifier is required");
    }
}
