...
/**
 * Abono (pago total o parcial) aplicado a una factura de proveedor. Append-only: nunca se edita ni
 * borra.
 */
public class SupplierInvoicePayment {
  ...
  public static SupplierInvoicePayment create(
      BigDecimal amount,
      LocalDate paymentDate,
      SupplierInvoicePaymentMethod method,
      String reference,
    ...
    return new SupplierInvoicePayment(
        null, amount, paymentDate, method, reference, note, LocalDateTime.now(), createdBy);
  }
