...
/**
 * Alineado con sus hermanos —{@code CreateCountryUseCase},
 * {@code UpdateCountryUseCase}, {@code DeleteCountryUseCase} y
 * {@code FindCountryUseCase} son {@code hasRole('SYSTEM')} a secas—, que es lo
 * que este puerto debio ser siempre: llevaba
 * {@code hasAuthority('country.update')} por copia del patron CRUD del tenant,
