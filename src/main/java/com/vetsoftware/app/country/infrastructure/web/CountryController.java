...
public class CountryController {
  ...
  public CountryController(
      CreateCountryUseCase createUseCase,
      UpdateCountryUseCase updateUseCase,
      FindCountryUseCase findUseCase,
      ListCountriesUseCase listUseCase,
  ...
  public CountryResponse update(
      @PathVariable Long id, @Valid @RequestBody UpdateCountryRequest request) {
