...
public record ClinicalEvent(Long sourceId, Long animalId, Long companyId, Long consultationId,
        LocalDate eventDate, LocalDate endDate, ClinicalEventType eventType, String summary) {
