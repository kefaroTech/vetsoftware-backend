 ...
 * vacunación, …) para el reporte PDF. Devuelve el título y los campos ya ordenados y sin valores
 * vacíos; {@code empty} si el evento no existe o pertenece a otra empresa.
 */
