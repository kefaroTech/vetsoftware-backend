...
/**
 * Evento clínico enriquecido para el reporte PDF: además del encabezado del timeline,
 * lleva los campos ricos (formato SOAP) y las tablas (medicamentos, medicaciones…)
 * cargados desde la entidad fuente.
 */
