...
/**
 * Lee la lista de problemas (POMR) del animal para el reporte PDF. Cruce cross-feature
 * permitido: solo importa el {@code ProblemJpaRepository} (persistencia), nunca su dominio
 * (los enums se resuelven vía {@code .name()}).
 */
@Component
