...
public class DewormingController {
  ...
  public DewormingController(
      CreateDewormingUseCase createUseCase,
  ...
  @PutMapping("/{id}")
  public DewormingResponse update(
      @PathVariable Long id, @Valid @RequestBody UpdateDewormingRequest request) {
    return toResponse(
