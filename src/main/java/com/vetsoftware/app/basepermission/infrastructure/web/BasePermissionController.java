...
public class BasePermissionController {
  ...
  public BasePermissionController(
      CreateBasePermissionUseCase createUseCase,
  ...
  public BasePermissionResponse create(@Valid @RequestBody CreateBasePermissionRequest request) {
    return toResponse(
        createUseCase.execute(
            new CreateBasePermissionCommand(
                request.name(), request.code(), request.subModuleId())));
  }
  ...
  @PutMapping("/{id}")
  public BasePermissionResponse update(
      @PathVariable Long id, @Valid @RequestBody UpdateBasePermissionRequest request) {
    return toResponse(
        updateUseCase.execute(
            new UpdateBasePermissionCommand(
                id, request.name(), request.code(), request.subModuleId())));
  }
