...
public class CreateBasePermissionService implements CreateBasePermissionUseCase {
  ...
  public CreateBasePermissionService(
    ...
    this.mandatoryBaseRolePermissionInitializationPort =
        mandatoryBaseRolePermissionInitializationPort;
  ...
  public BasePermissionDto execute(CreateBasePermissionCommand command) {
    ...
    BasePermission basePermission =
        BasePermission.create(command.name(), command.code(), subModule);
