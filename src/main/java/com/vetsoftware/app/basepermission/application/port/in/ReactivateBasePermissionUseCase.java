...
/**
 * Alineado con sus hermanos —{@code CreateBasePermissionUseCase},
 * {@code UpdateBasePermissionUseCase}, {@code DeleteBasePermissionUseCase} y
 * {@code FindBasePermissionUseCase} son {@code hasRole('SYSTEM')} a secas—, que
 * es lo que este puerto debio ser siempre: llevaba
 * {@code hasAuthority('base_permission.update')} por copia del patron CRUD del
