...
public class Animal {
    ...
    // Lo hidrata el
    // adaptador de persistencia vía applyCurrentWeight(); create/update no lo
    // tocan. Ver
    // WeightRecord.
    ...
    public void update(String name, String code, SpecieRef specie, BreedRef breed, OwnerRef owner,
            ...
            ReproductiveState reproductiveState, AnimalColorRef color, LocalDate bod, Integer size,
            boolean deceased, LocalDate deceasedDate) {
        validate(name, code, specie, breed, owner, gender, weightType, animalType,
                reproductiveState, color, size, deceased, deceasedDate, this.company);
        this.name = name;
        this.code = code;
        this.specie = specie;
        this.breed = breed;
    ...
    private static void validate(String name, String code, SpecieRef specie, BreedRef breed,
            OwnerRef owner, Gender gender, WeightType weightType, AnimalType animalType,
            ReproductiveState reproductiveState, AnimalColorRef color, Integer size,
            boolean deceased, LocalDate deceasedDate, CompanyRef company) {
        ...
        if (weightType == null)
            throw new IllegalArgumentException("weightType is required");
        if (animalType == null)
            throw new IllegalArgumentException("animalType is required");
