...
public record WeightRecordDto(Long id, Long animalId, String animalName, String animalCode,
    ...
    public static WeightRecordDto from(WeightRecord r) {
        return new WeightRecordDto(r.getId(), r.getAnimal().id(), r.getAnimal().name(),
                r.getAnimal().code(), r.getValue(), r.getUnit(), r.getMeasuredAt(), r.getSource(),
                r.getSourceId(), r.getNote(), r.getCreatedDate());
    }
}
