...
public record AnimalDto(
    ...
    String name,
    String code,
    SpecieSummaryDto specie,
    BreedSummaryDto breed,
    OwnerSummaryDto owner,
    Gender gender,
    WeightType weightType,
    AnimalType animalType,
    ReproductiveState reproductiveState,
    AnimalColorSummaryDto color,
    LocalDate bod,
    BigDecimal weight,
  ...
  public static AnimalDto from(Animal animal) {
    ...
    WeightType displayUnit =
        animal.getCurrentWeightUnit() != null
    ...
    return new AnimalDto(
        ...
        animal.getCurrentWeightMeasuredAt(),
        animal.getSize(),
        animal.isDeceased(),
        animal.getDeceasedDate(),
        CompanySummaryDto.from(animal.getCompany()),
