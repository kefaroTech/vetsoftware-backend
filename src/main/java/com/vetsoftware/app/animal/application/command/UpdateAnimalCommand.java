...
public record UpdateAnimalCommand(Long id, String name, String code, Long specieId, Long breedId,
        Long ownerId, Gender gender, WeightType weightType, AnimalType animalType,
        ReproductiveState reproductiveState, Long colorId, LocalDate bod, Integer size,
        boolean deceased, LocalDate deceasedDate, Long companyId) {
}
