...
public class AnimalJpaEntity {
    ...
    public BreedJpaEntity getBreed() { return breed; }
    public void setBreed(BreedJpaEntity breed) { this.breed = breed; }
    ...
    public void setWeightType(WeightType weightType) { this.weightType = weightType; }
    ...
    public void setDeceasedDate(LocalDate deceasedDate) { this.deceasedDate = deceasedDate; }
