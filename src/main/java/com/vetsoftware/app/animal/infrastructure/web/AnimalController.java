...
public class AnimalController {
  ...
  public AnimalController(
      CreateAnimalUseCase createUseCase,
      UpdateAnimalUseCase updateUseCase,
      FindAnimalUseCase findUseCase,
      ListAnimalsUseCase listUseCase,
      ListAnimalsByOwnerUseCase listByOwnerUseCase,
      DeleteAnimalUseCase deleteUseCase,
      ReactivateAnimalUseCase reactivateUseCase,
      Authz authz) {
  ...
  public AnimalResponse update(
      @PathVariable Long id, @Valid @RequestBody UpdateAnimalRequest request) {
    return toResponse(
