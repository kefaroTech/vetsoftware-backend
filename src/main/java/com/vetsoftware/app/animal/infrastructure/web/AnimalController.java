...
public class AnimalController {
    ...
    public AnimalController(CreateAnimalUseCase createUseCase, FindAnimalUseCase findUseCase,
            ListAnimalsUseCase listUseCase, ListAnimalsByOwnerUseCase listByOwnerUseCase,
            Authz authz) {
