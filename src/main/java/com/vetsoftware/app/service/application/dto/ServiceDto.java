...
public record ServiceDto(Long id, String name, BigDecimal price, TaxTreatment taxTreatment,
        String notes, ServiceCategorySummaryDto serviceCategory, TaxSummaryDto tax,
    ...
    public static ServiceDto from(Service service) {
        return new ServiceDto(service.getId(), service.getName(), service.getPrice(),
                service.getTaxTreatment(), service.getNotes(),
                ServiceCategorySummaryDto.from(service.getServiceCategory()),
                service.getTax() == null ? null : TaxSummaryDto.from(service.getTax()),
                CompanySummaryDto.from(service.getCompany()), service.getCreatedDate(),
                service.getUpdatedDate(), service.getUpdatedBy(), service.getVersion(),
                service.isEnabled());
    }
}
