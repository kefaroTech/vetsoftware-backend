...
@Entity
@Table(name = "services")
@SQLDelete(sql = "UPDATE services SET enabled = false WHERE id = ? AND version = ?")
...
public class ServiceJpaEntity {
    ...
    public ServiceCategoryJpaEntity getServiceCategory() {
        return serviceCategory;
    }

    public void setServiceCategory(ServiceCategoryJpaEntity serviceCategory) {
