...
public class Vaccination {
    ...
    public Vaccination(Long id, LocalDate date, VaccinationTypeRef vaccinationType,
                       String lot, String notes, String route, String applicationSite,
                       LocalDate nextVaccination, AnimalRef animal, ConsultationRef consultation,
    ...
    public static Vaccination create(LocalDate date, VaccinationTypeRef vaccinationType,
                                     String lot, String notes, String route, String applicationSite,
                                     LocalDate nextVaccination, AnimalRef animal,
    ...
    private static void validate(LocalDate date, VaccinationTypeRef vaccinationType,
        ...
        // route (vía) y applicationSite (sitio) son opcionales (WSAVA); solo se valida la longitud.
        if (route != null && route.length() > 30) throw new IllegalArgumentException("route must be 30 chars or less");
        if (applicationSite != null && applicationSite.length() > 60) throw new IllegalArgumentException("applicationSite must be 60 chars or less");
