...
public record VaccinationDto(Long id, LocalDate date, VaccinationTypeSummaryDto vaccinationType,
        String lot, String notes, String route, String applicationSite, LocalDate nextVaccination,
    ...
    public static VaccinationDto from(Vaccination vaccination) {
        return new VaccinationDto(vaccination.getId(), vaccination.getDate(),
                VaccinationTypeSummaryDto.from(vaccination.getVaccinationType()),
                vaccination.getLot(), vaccination.getNotes(), vaccination.getRoute(),
                vaccination.getApplicationSite(), vaccination.getNextVaccination(),
                ...
                CompanySummaryDto.from(vaccination.getCompany()), vaccination.getCreatedDate(),
