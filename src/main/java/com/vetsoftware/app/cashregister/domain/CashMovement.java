...
/**
 * Movimiento de caja (entidad hija, append-only e inmutable). El {@code amount} es siempre
 * positivo; el signo lo da el {@link CashMovementType#isInflow()}. Nunca se hace UPDATE/DELETE: las
 * correcciones son movimientos nuevos ({@code VOID_OUT} para reversar una venta/abono, {@code
