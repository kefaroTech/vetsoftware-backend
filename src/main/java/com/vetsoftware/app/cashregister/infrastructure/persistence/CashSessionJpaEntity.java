...
/**
 * Sesión de caja. La columna generada {@code open_marker} (= 1 solo cuando status=OPEN, NULL en
 * otro caso) vive en la BD para los índices únicos condicionales por terminal y por empleado; no se
 * mapea aquí (ddl-auto: validate ignora columnas no mapeadas). Movimientos y counts son append-only
