 ...
 */
public record CashSessionView(Long id, Long branchId, String branchName, Long terminalId, String terminal,
    ...
    public static CashSessionView from(CashSession s) {
        ...
        BigDecimal closingTotal = s.getStatus() == CashSessionStatus.CLOSED
            ...
            : null;
        return new CashSessionView(s.getId(), s.getBranchId(), null, s.getTerminalId(), s.getTerminal(), s.getStatus(),
    ...
    public static CashSessionView summary(Long id, Long branchId, String branchName, Long terminalId, String terminal,
        ...
        return new CashSessionView(id, branchId, branchName, terminalId, terminal, status, openedByEmployeeId,
