...
public record CashMovementView(Long id, CashMovementType type, CashPaymentMethod method, BigDecimal amount,
    ...
    public static CashMovementView from(CashMovement m) {
        return new CashMovementView(m.getId(), m.getType(), m.getMethod(), m.getAmount(), m.getReferenceType(),
