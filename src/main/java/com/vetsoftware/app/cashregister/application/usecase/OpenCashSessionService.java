...
/**
 * Abre la caja de una sede con la base inicial. Cada empleado puede mantener una sola sesión OPEN y
 * cada terminal solo una por sede; los índices únicos condicionales de la BD cubren las carreras
 * residuales.
 */
...
public class OpenCashSessionService implements OpenCashSessionUseCase {
  ...
  public CashSessionView open(OpenCashSessionCommand command) {
    ...
    CashTerminalQueryPort.TerminalRef terminal =
        terminalQueryPort
