...
public class SpaJpaMapper {
  ...
  public SpaJpaEntity toJpa(
      Spa spa, SpaTypeJpaEntity spaType, AnimalJpaEntity animal, CompanyJpaEntity company) {
  ...
  public Spa toDomain(
      SpaJpaEntity entity, SpaTypeRef spaTypeRef, AnimalRef animalRef, CompanyRef companyRef) {
    return new Spa(
        entity.getId(),
        entity.getDate(),
        spaTypeRef,
