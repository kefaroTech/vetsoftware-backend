...
/**
 * Orden de compra = pedido de productos a un proveedor para una sede. Agregado company-scoped con
 * soft-delete y bloqueo optimista (@Version). Su ciclo de vida lo gobierna {@link
 * PurchaseOrderStatus}: se crea en DRAFT (editable), se emite con {@link #place}, se recibe línea a
 * línea (mueve a PARTIALLY_RECEIVED/RECEIVED) y puede cancelarse mientras no se haya recibido nada.
 */
public class PurchaseOrder {
  ...
  /**
   * Recalcula el estado tras aplicar recepciones: todo recibido → RECEIVED; algo recibido →
   * PARTIALLY_RECEIVED.
   */
  ...
  /**
   * Recalcula el estado tras revertir recepciones: algo recibido → PARTIALLY_RECEIVED; nada →
   * PLACED.
   */
