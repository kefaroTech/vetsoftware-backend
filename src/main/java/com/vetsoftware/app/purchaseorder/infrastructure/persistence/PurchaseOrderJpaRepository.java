...
public interface PurchaseOrderJpaRepository
    extends JpaRepository<PurchaseOrderJpaEntity, Long>,
  ...
  @org.springframework.data.jpa.repository.Query(
      value =
          "SELECT * FROM purchase_orders WHERE company_id = :companyId AND enabled = false "
  ...
  @org.springframework.data.jpa.repository.Query(
      value =
          "UPDATE purchase_orders SET enabled = true WHERE id = :id AND company_id = :companyId",
      nativeQuery = true)
  int reactivate(
