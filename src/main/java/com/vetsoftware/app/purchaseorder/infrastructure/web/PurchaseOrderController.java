...
public class PurchaseOrderController {
  ...
  public PageResponse<PurchaseOrderResponse> search(
    ...
    PageResult<PurchaseOrderDto> result =
        searchUseCase.execute(
            new SearchPurchaseOrdersCommand(
  ...
  public PurchaseOrderResponse update(
      @PathVariable Long id, @Valid @RequestBody UpdatePurchaseOrderRequest request) {
    return toResponse(
  ...
  public PurchaseOrderResponse place(@PathVariable Long id) {
    return toResponse(
        placeUseCase.execute(id, authz.currentCompanyId(), authz.currentEmployeeIdOrNull()));
  }
