...
public class Promotion {
    ...
    public static Promotion create(String name, PromotionType promotionType,
            ApplicationType applicationType, Long applicationItem, ValueType valueType,
            BigDecimal value, LocalDateTime startDate, LocalDateTime endDate,
    ...
    public void update(String name, PromotionType promotionType, ApplicationType applicationType,
            Long applicationItem, ValueType valueType, BigDecimal value, LocalDateTime startDate,
            LocalDateTime endDate, PromotionStatus promotionStatus, CompanyRef company) {
        validate(name, promotionType, applicationType, applicationItem, valueType, value, startDate,
                endDate, promotionStatus, company);
        this.name = name;
        this.promotionType = promotionType;
    ...
    private static void validate(String name, PromotionType promotionType,
            ApplicationType applicationType, Long applicationItem, ValueType valueType,
            BigDecimal value, LocalDateTime startDate, LocalDateTime endDate,
            PromotionStatus promotionStatus, CompanyRef company) {
        ...
        if (promotionType == null)
            throw new IllegalArgumentException("promotionType is required");
        ...
        if (promotionStatus == null)
            throw new IllegalArgumentException("promotionStatus is required");
        if (company == null)
