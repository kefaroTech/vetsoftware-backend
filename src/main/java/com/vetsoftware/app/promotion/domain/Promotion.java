...
public class Promotion {
    ...
    public Promotion(Long id, String name, PromotionType promotionType, ApplicationType applicationType,
                     Long applicationItem, ValueType valueType, BigDecimal value,
                     LocalDateTime startDate, LocalDateTime endDate, PromotionStatus promotionStatus,
                     CompanyRef company, LocalDateTime createdDate, boolean enabled) {
        validate(name, promotionType, applicationType, applicationItem, valueType, value,
                startDate, endDate, promotionStatus, company);
        this.id = id;
        this.name = name;
    ...
    public static Promotion create(String name, PromotionType promotionType, ApplicationType applicationType,
                                   Long applicationItem, ValueType valueType, BigDecimal value,
                                   LocalDateTime startDate, LocalDateTime endDate,
                                   PromotionStatus promotionStatus, CompanyRef company) {
        return new Promotion(null, name, promotionType, applicationType, applicationItem, valueType, value,
                startDate, endDate, promotionStatus, company, LocalDateTime.now(), true);
    }
    ...
    private static void validate(String name, PromotionType promotionType, ApplicationType applicationType,
                                 Long applicationItem, ValueType valueType, BigDecimal value,
                                 LocalDateTime startDate, LocalDateTime endDate,
                                 PromotionStatus promotionStatus, CompanyRef company) {
