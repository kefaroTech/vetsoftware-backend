...
public record PromotionDto(
  ...
  public static PromotionDto from(Promotion promotion) {
    return new PromotionDto(
        ...
        promotion.getApplicationType(),
        promotion.getApplicationItem(),
        promotion.getValueType(),
        promotion.getValue(),
        promotion.getStartDate(),
        promotion.getEndDate(),
        promotion.getPromotionStatus(),
        promotion.getCompany() == null ? null : CompanySummaryDto.from(promotion.getCompany()),
