...
public class HospitalizationProgressNote {
  ...
  public HospitalizationProgressNote(
      Long id,
      String description,
  ...
  public static HospitalizationProgressNote create(
      String description, HospitalizationRef hospitalization, EmployeeRef createdBy) {
    return new HospitalizationProgressNote(
        null, description, hospitalization, createdBy, LocalDateTime.now(), true);
  }
