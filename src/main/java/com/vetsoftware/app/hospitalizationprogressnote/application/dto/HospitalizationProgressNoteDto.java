...
public record HospitalizationProgressNoteDto(Long id, String description,
    ...
    public static HospitalizationProgressNoteDto from(HospitalizationProgressNote progressNote) {
        return new HospitalizationProgressNoteDto(progressNote.getId(),
                progressNote.getDescription(),
                HospitalizationSummaryDto.from(progressNote.getHospitalization()),
                EmployeeSummaryDto.from(progressNote.getCreatedBy()), progressNote.getCreatedDate(),
