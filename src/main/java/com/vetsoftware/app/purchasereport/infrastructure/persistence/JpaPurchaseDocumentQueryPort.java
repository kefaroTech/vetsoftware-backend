...
/**
 * Lee las facturas de proveedor de la empresa (read-only) para el libro de compras (F4). Cruce
 * permitido de vertical slicing: la infraestructura de {@code purchasereport} importa el
 * JpaRepository/JpaEntity de {@code supplierinvoice}. Deriva pagado/saldo desde los abonos y expone
 * el estado como String en el borde.
 */
@Component
public class JpaPurchaseDocumentQueryPort implements PurchaseDocumentQueryPort {
  ...
  @Override
  public List<PurchaseDocumentView> findByCompanyAndDateRange(
