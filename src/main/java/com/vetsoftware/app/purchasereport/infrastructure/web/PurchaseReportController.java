...
/**
 * F4 - libro de compras (reporte contable de solo lectura). Complementa el libro de ventas (punto
 * 16).
 */
@RestController
...
public class PurchaseReportController {
  ...
  public PurchaseReportController(
      GetPurchaseBookUseCase purchaseBookUseCase,
  ...
  public PurchaseBookDto purchaseBook(
    ...
    return purchaseBookUseCase.get(
