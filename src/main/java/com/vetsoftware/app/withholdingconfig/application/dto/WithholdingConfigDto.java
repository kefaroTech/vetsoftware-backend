...
public record WithholdingConfigDto(Long id, Long companyId, BigDecimal reteFuenteRate,
    ...
    public static WithholdingConfigDto from(WithholdingConfig c) {
        return new WithholdingConfigDto(c.getId(),
                c.getCompany() == null ? null : c.getCompany().id(), c.getReteFuenteRate(),
                c.getReteIvaRate(), c.getReteIcaRate(), c.getCreatedDate(), c.isEnabled());
    }
}
