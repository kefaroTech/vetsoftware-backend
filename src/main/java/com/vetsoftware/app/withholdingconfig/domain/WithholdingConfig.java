...
/**
 * Tarifas de retención del emisor (0-o-1 por empresa). reteFuente/reteIca
 * aplican % sobre la base; reteIva aplica % sobre el IVA generado. Se usan al
 * emitir cuando el adquiriente es agente retenedor.
 */
