 ...
 * reteIva aplica % sobre el IVA generado. Se usan al emitir cuando el adquiriente es agente
 * retenedor.
 */
public class WithholdingConfig {
  ...
  public static WithholdingConfig create(
      CompanyRef company,
      BigDecimal reteFuenteRate,
      BigDecimal reteIvaRate,
      BigDecimal reteIcaRate) {
    return new WithholdingConfig(
        null, company, reteFuenteRate, reteIvaRate, reteIcaRate, LocalDateTime.now(), true);
  }
