...
public record PublishAdminPermissionsDto(int companiesProcessed, int companiesUpdated,
    ...
    public static PublishAdminPermissionsDto from(PublishAdminPermissionsResult result) {
        return new PublishAdminPermissionsDto(result.companiesProcessed(),
                result.companiesUpdated(), result.permissionsCreated(),
