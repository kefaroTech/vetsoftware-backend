...
public class PublishAdminPermissionsService implements PublishAdminPermissionsUseCase {
  ...
  public PublishAdminPermissionsService(
  ...
  public PublishAdminPermissionsDto execute() {
    Long adminBaseRoleId =
        adminBaseRoleQueryPort
            .findAdminBaseRoleId()
    ...
    Set<Long> membershipIds =
        companies.stream().map(CompanyAdminContext::membershipId).collect(Collectors.toSet());
