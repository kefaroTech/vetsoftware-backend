...
public class PetshopCatalogController {
  ...
  public PresentationDto createPresentation(@Valid @RequestBody PresentationRequest request) {
    return useCase.createPresentation(
        toCommand(request), authz.currentCompanyId(), authz.currentEmployeeIdOrNull());
  }
  ...
  public PresentationDto updatePresentation(
    ...
    return useCase.updatePresentation(
        id, toCommand(request), authz.currentCompanyId(), authz.currentEmployeeIdOrNull());
  }
  ...
  public BundleDto createBundle(@Valid @RequestBody BundleRequest request) {
    return useCase.createBundle(
        toCommand(request), authz.currentCompanyId(), authz.currentEmployeeIdOrNull());
  }

  @PutMapping("/bundles/{id}")
  public BundleDto updateBundle(@PathVariable Long id, @Valid @RequestBody BundleRequest request) {
    return useCase.updateBundle(
        id, toCommand(request), authz.currentCompanyId(), authz.currentEmployeeIdOrNull());
  }
