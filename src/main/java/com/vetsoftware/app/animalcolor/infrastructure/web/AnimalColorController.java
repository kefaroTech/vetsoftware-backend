...
public class AnimalColorController {
  ...
  public AnimalColorController(
      CreateAnimalColorUseCase createUseCase,
  ...
  @PutMapping("/{id}")
  public AnimalColorResponse update(
      @PathVariable Long id, @Valid @RequestBody UpdateAnimalColorRequest request) {
