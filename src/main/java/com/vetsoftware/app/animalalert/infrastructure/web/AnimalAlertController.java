...
public class AnimalAlertController {
  ...
  public AnimalAlertController(
      CreateAnimalAlertUseCase createUseCase,
  ...
  @PutMapping("/{id}")
  public AnimalAlertResponse update(
      @PathVariable Long id, @Valid @RequestBody UpdateAnimalAlertRequest request) {
    return toResponse(
