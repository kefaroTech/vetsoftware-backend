...
public class AnimalAlertJpaMapper {
  ...
  public AnimalAlertJpaEntity toJpa(
      AnimalAlert alert, AnimalJpaEntity animal, CompanyJpaEntity company) {
  ...
  public AnimalAlert toDomain(
      AnimalAlertJpaEntity entity, AnimalRef animalRef, CompanyRef companyRef) {
