...
public class AnimalAlert {
  ...
  public static AnimalAlert create(
      AnimalRef animal,
      AlertType type,
      String description,
      AlertSeverity severity,
    ...
    return new AnimalAlert(
        null, animal, company, type, description, severity, LocalDateTime.now(), true);
  }
  ...
  private static void validate(
      AlertType type, String description, AnimalRef animal, CompanyRef company) {
