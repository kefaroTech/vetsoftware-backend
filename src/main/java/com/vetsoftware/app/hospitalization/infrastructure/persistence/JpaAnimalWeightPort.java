...
public class JpaAnimalWeightPort implements AnimalWeightPort {
  ...
  @Override
  public void recordHospitalizationWeight(
      Long animalId,
      Long companyId,
      BigDecimal value,
      String unit,
    ...
    weightRecordJpaRepository.save(
        WeightRecordJpaEntity.of(
            animal, company, value, unit, "HOSPITALIZATION", hospitalizationId, null, measuredAt));
  }
}
