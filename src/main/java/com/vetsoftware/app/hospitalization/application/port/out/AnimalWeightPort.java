...
/**
 * Puerto para registrar el peso capturado al ingresar una hospitalización como
 * punto de la serie temporal del animal (feature animal). La unidad viaja como
 * String; el paquete animal resuelve el enum, respetando el vertical slicing.
 */
