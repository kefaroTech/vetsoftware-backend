...
/**
 * Configuracion del proveedor DIAN de una empresa (0-o-1 por empresa). Hoy el
 * unico proveedor es MATIAS, que autentica por login (username=email +
 * password) o por PAT estatico (apiToken). El esquema es agnostico por si se
 * agregan mas proveedores. Los secretos se cifran en la capa de persistencia
...
public class DianProviderConfig {
    ...
    // Credenciales de login MATIAS: username = email, password.
    // (clientId/clientSecret reservados,
    // sin uso hoy.)
    ...
    public void update(ProviderType provider, String baseUrl, String clientId, String clientSecret,
            String username, String password, String apiToken, String webhookSecret,
