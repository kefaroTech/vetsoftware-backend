...
public class DianProviderConfigController {
  ...
  public DianProviderConfigController(
      CreateDianProviderConfigUseCase createUseCase,
  ...
  public DianProviderConfigDto create(@Valid @RequestBody CreateDianProviderConfigRequest request) {
    return createUseCase.execute(
        new CreateDianProviderConfigCommand(
            request.provider(),
            request.baseUrl(),
            request.clientId(),
  ...
  public DianProviderConfigDto update(@Valid @RequestBody UpdateDianProviderConfigRequest request) {
    return updateUseCase.execute(
        new UpdateDianProviderConfigCommand(
            request.provider(),
            request.baseUrl(),
            request.clientId(),
            request.clientSecret(),
