...
/**
 * Resultado del auto-registro (Opción B). NO incluye token de sesión: la cuenta
 * queda pendiente de verificar el correo antes de poder iniciar sesión. El
 * usuario de acceso es el propio {@code
