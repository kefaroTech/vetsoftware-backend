 ...
 * en BD solo se guarda su hash SHA-256. Al verificar se re-hashea el valor recibido y se busca por
 * hash, de modo que una filtracion de la tabla no revela tokens usables.
 */
