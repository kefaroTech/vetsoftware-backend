...
public class CreateEmployeeAdapter implements EmployeeCreator {
    ...
    @Override
    public EmployeeResult create(String employeeCode, String rawPassword, String name, String email,
            Long companyId) {
        // Auto-registro público: el dueño se crea SIN verificar (no podrá iniciar
        // sesión hasta
        // confirmar el
        // correo — Opción B). La contraseña va CRUDA; CreateEmployeeService la hashea
        // una sola vez.
        var dto = systemAuthRunner
                .call(() -> createEmployeeUseCase.execute(new CreateEmployeeCommand(employeeCode,
                        rawPassword, name, email, companyId, false)));
