...
public class RegistrationController {
  ...
  public RegistrationResponse register(
    ...
    // Auditoría: alta de nueva veterinaria (empresa) por auto-registro. El usuario de acceso es el
    // correo.
    auditLogger.companyRegistered(
        dto.companyId(),
        request.companyName(),
        request.companyIdentifier(),
        dto.employeeId(),
  ...
  /**
   * Confirma el correo del dueño con el token recibido por email (Opción B). Tras esto, ya puede
   * iniciar sesión.
   */
  @PostMapping("/verify")
