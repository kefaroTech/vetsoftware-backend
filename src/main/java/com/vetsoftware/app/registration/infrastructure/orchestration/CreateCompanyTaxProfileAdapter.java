...
/**
 * Único punto de orquestación que conoce la feature companytaxprofile. Crea el perfil fiscal del
 * emisor durante el signup público con el tipo de documento elegido, DV autocalculado por el
 * service (para NIT) y sin responsabilidades.
 */
@Component
public class CreateCompanyTaxProfileAdapter implements CompanyTaxProfileCreator {
  ...
  public void create(
    ...
    systemAuthRunner.call(
        () ->
            createCompanyTaxProfileUseCase.execute(
