...
/**
 * Único punto de orquestación que conoce la feature companytaxprofile. Crea el
 * perfil fiscal del emisor durante el signup público con el tipo de documento
 * elegido, DV autocalculado por el service (para NIT) y sin responsabilidades.
 */
@Component
public class CreateCompanyTaxProfileAdapter implements CompanyTaxProfileCreator {
    ...
    public CreateCompanyTaxProfileAdapter(
            CreateCompanyTaxProfileUseCase createCompanyTaxProfileUseCase,
    ...
    public void create(Long companyId, String documentType, String documentId, String legalName,
        ...
        systemAuthRunner.call(
                () -> createCompanyTaxProfileUseCase.execute(new CreateCompanyTaxProfileCommand(
                        CompanyDocumentType.valueOf(documentType), documentId, null, // DV:
                                                                                     // lo
                                                                                     // autocalcula
                                                                                     // el
                                                                                     // service
                                                                                     // para
                                                                                     // NIT
                        legalName, TaxRegime.valueOf(taxRegime), fiscalEmail, null, // commercialName
