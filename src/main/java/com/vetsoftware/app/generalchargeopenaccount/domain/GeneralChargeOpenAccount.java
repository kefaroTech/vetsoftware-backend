...
public class GeneralChargeOpenAccount {
    ...
    /**
     * Porcentaje de impuesto congelado al crear/actualizar el cargo; null si no
     * aplica impuesto.
     */
    private BigDecimal taxPercentage;

    /**
     * Nombre del impuesto congelado: sobrevive aunque el catálogo deshabilite el
     * impuesto.
     */
    ...
    /**
     * Desglose tributario persistido: el monto incluye IVA → base = total / (1 +
     * tasa), iva = total - base.
     */
    ...
    public GeneralChargeOpenAccount(Long id, String name, BigDecimal unitAmount,
    ...
    public static GeneralChargeOpenAccount create(String name, BigDecimal unitAmount,
            BigDecimal quantity, TaxRef tax, OpenAccountRef openAccount, EmployeeRef createdBy,
            String clientRequestId) {
    ...
    public void voidCharge(EmployeeRef voidedBy, String reason) {
        if (this.voided)
            throw new GeneralChargeOpenAccountAlreadyVoidedException(this.id);
        if (voidedBy == null)
    ...
    /**
     * Congela el % de impuesto vigente: el total no debe cambiar si el catálogo de
     * impuestos se edita.
     */
    ...
    /**
     * Congela el esquema tributario (IVA/INC) del impuesto asignado; null si no
     * aplica impuesto.
     */
    ...
    /**
     * Monto efectivo que el cargo aporta al total de la cuenta (= total_amount
     * persistido).
     */
