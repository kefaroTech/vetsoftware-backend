...
public class GeneralChargeOpenAccount {
  ...
  /**
   * Desglose tributario persistido: el monto incluye IVA → base = total / (1 + tasa), iva = total -
   * base.
   */
  ...
  public GeneralChargeOpenAccount(
      Long id,
      String name,
  ...
  public static GeneralChargeOpenAccount create(
      String name,
      BigDecimal unitAmount,
      BigDecimal quantity,
      TaxRef tax,
    ...
    return new GeneralChargeOpenAccount(
        ...
        hasTax,
        pct,
        snapshotTaxName(tax, hasTax),
        snapshotTaxScheme(tax, hasTax),
        base,
        total.subtract(base),
        total,
        openAccount,
  ...
  /**
   * Congela el % de impuesto vigente: el total no debe cambiar si el catálogo de impuestos se
   * edita.
   */
  ...
  private static void validate(
      String name, BigDecimal unitAmount, BigDecimal quantity, OpenAccountRef openAccount) {
