...
public class CreateGeneralChargeOpenAccountService
    implements CreateGeneralChargeOpenAccountUseCase {
  ...
  public CreateGeneralChargeOpenAccountService(
  ...
  public GeneralChargeOpenAccountDto execute(CreateGeneralChargeOpenAccountCommand command) {
    ...
    if (command.clientRequestId() != null && !command.clientRequestId().isBlank()) {
      Optional<GeneralChargeOpenAccount> existing =
    ...
    GeneralChargeOpenAccount charge =
        GeneralChargeOpenAccount.create(
            command.name(),
            command.unitAmount(),
            command.quantity(),
            tax,
