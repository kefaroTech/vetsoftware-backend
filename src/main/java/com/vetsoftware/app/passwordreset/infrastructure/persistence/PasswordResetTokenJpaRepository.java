...
public interface PasswordResetTokenJpaRepository
  ...
  // Invalida (consume) todos los tokens vivos del empleado de una vez, sin cargarlos como
  // entidades.
  ...
  int consumeActiveForEmployee(
      @Param("employeeId") Long employeeId, @Param("now") LocalDateTime now);
}
