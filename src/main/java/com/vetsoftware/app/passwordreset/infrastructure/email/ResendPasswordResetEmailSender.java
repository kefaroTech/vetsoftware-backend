...
/**
 * Correo de restablecimiento de contraseña enviado con una <b>plantilla de Resend</b> ({@code
 * template: { id, variables }}). El enlace apunta a la página del front ({@code reset-base-url})
 * con el token plano; el front llama a {@code POST /auth/reset-password}. Async/best-effort: si
 * Resend falla o el envío está deshabilitado (dev), se registra el enlace/aviso en el log y el
 * flujo continúa.
 *
