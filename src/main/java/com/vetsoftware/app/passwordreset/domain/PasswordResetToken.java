...
/**
 * Token de un solo uso para restablecer la contraseña de un empleado. Persiste el HASH del valor
 * (nunca el valor plano); el valor plano solo viaja en el enlace del correo. Las invariantes de
 * consumo (no expirado, no reusado) viven aquí, en el dominio. La posesión del token es la
 * autorización.
 */
