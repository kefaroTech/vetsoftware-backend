...
/**
 * Generación y hashing de tokens de restablecimiento. El valor plano (raw) viaja en el enlace del
 * correo; en BD solo se guarda su hash SHA-256. Al validar/usar se re-hashea el valor recibido y se
 * busca por hash, de modo que una filtración de la tabla no revela tokens usables.
 */
