...
/**
 * Solicita el restablecimiento de contraseña. Sin @PreAuthorize: flujo público. No revela si el
 * código existe (anti-enumeración): siempre completa sin error, envíe o no el correo.
 */
