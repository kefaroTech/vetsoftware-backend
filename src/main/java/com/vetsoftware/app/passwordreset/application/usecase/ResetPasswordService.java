...
/**
 * Confirma el restablecimiento: re-hashea el token plano, lo consume de forma irreversible y aplica
 * la nueva contraseña al empleado (que además invalida sus sesiones vivas). La posesión del token
 * es la autorización.
 */
