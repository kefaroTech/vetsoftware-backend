...
/**
 * Confirma el restablecimiento: consume el token y cambia la contraseña del empleado.
 * Sin @PreAuthorize: la autorización es la posesión del token de un solo uso.
 */
