 ...
 *
 * <p>{@code traceId} y {@code spanId} no se declaran aquí: Micrometer Tracing es su único dueño y
 * administra automáticamente su alta, restauración y limpieza en el MDC.
 *
