...
public final class BusinessMetricCardinalityFilter implements MeterFilter {
    ...
    private static final Map<String, Set<String>> ALLOWED_VALUES = Map.ofEntries(
            Map.entry("result", Set.of(
                    "completed", "rejected", "cancelled", "error", "validated", "contingency",
                    "pending", "success", "insufficient_stock", "duplicate_ignored",
                    "validation_error", "difference")),
            Map.entry("channel", Set.of("pos", "open_account", "staff", "public")),
            Map.entry("document.type", Set.of(
                    "fe_venta", "doc_equiv_pos", "nota_credito", "nota_debito", "unknown")),
            Map.entry("origin", Set.of("initial", "retry", "webhook", "reconciliation")),
            Map.entry("status", Set.of(
                    "pending", "contingency", "requested", "confirmed", "arrived",
                    "in_progress", "completed", "no_show", "cancelled")),
            Map.entry("age", Set.of(
                    "lt_15m", "from_15m_to_1h", "gt_1h", "expired",
                    "from_0_to_7d", "from_8_to_30d")),
            Map.entry("movement.type", Set.of(
                    "purchase", "sale", "clinical_use", "adjustment_in", "adjustment_out",
