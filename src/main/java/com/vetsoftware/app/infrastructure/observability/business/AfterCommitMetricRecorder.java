...
/**
 * Evita publicar éxitos de negocio antes de confirmar la transacción. Las métricas son best-effort:
 * un fallo del registro nunca debe cambiar el resultado del caso de uso.
 */
@Component
