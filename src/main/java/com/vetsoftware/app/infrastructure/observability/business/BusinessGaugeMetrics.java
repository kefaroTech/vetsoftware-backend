...
public class BusinessGaugeMetrics implements MeterBinder {
  ...
  @Autowired
  public BusinessGaugeMetrics(
      ElectronicDocumentJpaRepository electronicDocuments,
  ...
  private BacklogSnapshot loadBacklog(
      DianStatus status, LocalDateTime fifteenMinutesAgo, LocalDateTime oneHourAgo) {
  ...
  private record BacklogSnapshot(
      long lessThanFifteenMinutes, long fromFifteenMinutesToOneHour, long moreThanOneHour) {}
