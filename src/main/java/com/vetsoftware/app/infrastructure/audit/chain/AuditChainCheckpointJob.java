 ...
 *
 * <p>Emite periódicamente un evento con la cabeza de la cadena. Al viajar por la misma ruta que el
 * resto de la auditoría, termina en el bucket con Object Lock en modo COMPLIANCE, donde ya no puede
 * modificarse ni borrarse antes de que expire la retención.
 *
 * <p>Eso es lo que convierte la cadena en evidencia y no solo en una suma de comprobación: para
 * reescribir la historia habría que alterar además un objeto que es inmutable incluso para la
 * cuenta raíz. Sin el ancla, alguien con acceso a la base podría recalcular toda la cadena tras
 * manipular un evento y quedaría consistente.
 *
 * <p>El propio checkpoint entra en la cadena como un eslabón más, así que la secuencia que reporta
