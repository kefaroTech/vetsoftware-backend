...
/**
 * Recorre toda la ventana retenida de la cadena en cada pasada y publica el resultado como métrica.
 *
 * <p><b>La pasada es completa a propósito.</b> Una verificación incremental que solo mirase los
 * eslabones nuevos sería inútil: el ataque probable no es alterar un evento futuro sino uno
 * <em>pasado</em>, y un cursor que nunca vuelve atrás jamás lo vería. La cobertura se paga con
 * lectura y CPU, y el mando para regularla es {@code verify-interval}, nunca recortar el alcance.
 *
 * <p>El recorrido va por lotes para acotar la memoria, arrastrando el eslabón esperado entre lotes.
 * Como el trabajo usa {@code fixedDelay}, dos pasadas nunca se solapan aunque una tarde más que el
 * intervalo.
 */
@Component
