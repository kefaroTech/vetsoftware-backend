 ...
 * distinguen dos valores; este describe el del <em>cliente al que Lumbre le
 * factura</em> y tiene cuatro, que son las cuatro que admite el {@code CHECK}
 * de esta tabla. Compartirlos —o importar el de la otra feature— seria
 * exactamente lo que prohibe el vertical slicing, y ademas ataria dos listas
 * cerradas que cambian con normas distintas.
 */
