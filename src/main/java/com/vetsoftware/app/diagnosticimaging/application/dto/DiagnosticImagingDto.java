...
public record DiagnosticImagingDto(Long id, LocalDate date,
        DiagnosticImagingTypeSummaryDto diagnosticImagingType, String clinicalSigns,
        String studyType, String diagnosis, String observations, String status,
    ...
    public static DiagnosticImagingDto from(DiagnosticImaging imaging) {
        return new DiagnosticImagingDto(imaging.getId(), imaging.getDate(),
                DiagnosticImagingTypeSummaryDto.from(imaging.getDiagnosticImagingType()),
                imaging.getClinicalSigns(), imaging.getStudyType(), imaging.getDiagnosis(),
                imaging.getObservations(), imaging.getStatus().name(),
                AnimalSummaryDto.from(imaging.getAnimal()),
                imaging.getConsultation() == null
                        ? null
                        : ConsultationSummaryDto.from(imaging.getConsultation()),
                CompanySummaryDto.from(imaging.getCompany()), imaging.getCreatedDate(),
                imaging.isEnabled());
    }
}
