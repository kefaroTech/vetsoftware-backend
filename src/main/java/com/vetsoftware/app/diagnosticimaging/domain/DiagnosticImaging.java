...
public class DiagnosticImaging {
  ...
  public DiagnosticImaging(
      Long id,
      LocalDate date,
      DiagnosticImagingTypeRef diagnosticImagingType,
      String clinicalSigns,
      String studyType,
      String diagnosis,
      String observations,
      DiagnosticImagingStatus status,
      AnimalRef animal,
  ...
  public static DiagnosticImaging create(
      LocalDate date,
      DiagnosticImagingTypeRef diagnosticImagingType,
      String clinicalSigns,
      String studyType,
    ...
    return new DiagnosticImaging(
        ...
        diagnosis,
        observations,
        DiagnosticImagingStatus.PENDIENTE,
        animal,
        consultation,
        company,
        LocalDateTime.now(),
