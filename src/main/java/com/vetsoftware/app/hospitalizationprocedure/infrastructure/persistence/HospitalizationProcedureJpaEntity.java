...
@Entity
@Table(name = "hospitalization_procedures")
@SQLDelete(sql = "UPDATE hospitalization_procedures SET enabled = false WHERE id = ?")
@SQLRestriction("enabled = true")
public class HospitalizationProcedureJpaEntity {
    @Id
