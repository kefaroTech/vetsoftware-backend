...
public record MembershipSubModuleDto(Long id, MembershipSummaryDto membership,
    ...
    public static MembershipSubModuleDto from(MembershipSubModule membershipSubModule) {
        return new MembershipSubModuleDto(membershipSubModule.getId(),
                MembershipSummaryDto.from(membershipSubModule.getMembership()),
                SubModuleSummaryDto.from(membershipSubModule.getSubModule()),
                membershipSubModule.getCreatedDate(), membershipSubModule.isEnabled());
    }
}
