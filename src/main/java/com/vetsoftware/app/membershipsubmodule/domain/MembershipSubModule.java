...
public class MembershipSubModule {
    ...
    public MembershipSubModule(Long id, Long membershipId, Long subModuleId, LocalDateTime createdDate) {
    ...
    public static MembershipSubModule create(Long membershipId, Long subModuleId) {
        return new MembershipSubModule(null, membershipId, subModuleId, LocalDateTime.now());
    }
