...
public record NumberingResolutionDto(Long id, CompanySummaryDto company, Long branchId,
    ...
    public static NumberingResolutionDto from(NumberingResolution resolution) {
        return new NumberingResolutionDto(resolution.getId(),
                resolution.getCompany() == null
                        ? null
                        : CompanySummaryDto.from(resolution.getCompany()),
                resolution.getBranchId(), resolution.getDocumentType(),
                resolution.getResolutionNumber(), resolution.getResolutionDate(),
                resolution.getPrefix(), resolution.getRangeFrom(), resolution.getRangeTo(),
                resolution.getValidFrom(), resolution.getValidTo(), resolution.getTechnicalKey(),
                resolution.getCurrentNumber(), resolution.getCreatedDate(), resolution.isEnabled());
    }
}
