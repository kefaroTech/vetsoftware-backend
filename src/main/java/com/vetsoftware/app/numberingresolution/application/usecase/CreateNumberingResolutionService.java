...
public class CreateNumberingResolutionService implements CreateNumberingResolutionUseCase {
  ...
  public NumberingResolutionDto execute(CreateNumberingResolutionCommand command) {
    ...
    // Invariante: una sola resolución activa por (empresa, SEDE, tipo). La carrera la respalda el
    // índice
    // único de BD (uq_numbering_resolutions_active_scope); este check da el error de negocio
    // amigable.
