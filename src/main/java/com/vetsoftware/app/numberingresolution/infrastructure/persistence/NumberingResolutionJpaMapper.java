...
public class NumberingResolutionJpaMapper {
    public NumberingResolutionJpaEntity toJpa(NumberingResolution resolution,
    ...
    public NumberingResolution toDomain(NumberingResolutionJpaEntity entity,
        ...
        return new NumberingResolution(entity.getId(), companyRef, entity.getDocumentType(),
                entity.getResolutionNumber(), entity.getResolutionDate(), entity.getPrefix(),
                entity.getRangeFrom(), entity.getRangeTo(), entity.getValidFrom(),
                entity.getValidTo(), entity.getTechnicalKey(), entity.getCurrentNumber(),
                entity.getCreatedDate(), entity.isEnabled(), entity.getBranchId());
    }
}
