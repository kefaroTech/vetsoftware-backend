...
public class NumberingResolutionController {
  ...
  public NumberingResolutionController(
      CreateNumberingResolutionUseCase createUseCase,
  ...
  public NumberingResolutionResponse create(
    ...
    return toResponse(
        createUseCase.execute(
            new CreateNumberingResolutionCommand(
  ...
  @PutMapping("/{id}")
  public NumberingResolutionResponse update(
      @PathVariable Long id, @Valid @RequestBody UpdateNumberingResolutionRequest request) {
    return toResponse(
        updateUseCase.execute(
            new UpdateNumberingResolutionCommand(
                id,
                request.documentType(),
                request.resolutionNumber(),
                request.resolutionDate(),
