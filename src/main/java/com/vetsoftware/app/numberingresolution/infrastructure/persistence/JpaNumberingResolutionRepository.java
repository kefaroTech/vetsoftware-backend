...
public class JpaNumberingResolutionRepository implements NumberingResolutionRepository {
  ...
  public JpaNumberingResolutionRepository(
      NumberingResolutionJpaRepository jpaRepository,
  ...
  @Override
  public boolean existsActiveByCompanyBranchAndType(
      Long companyId,
      Long branchId,
      com.vetsoftware.app.numberingresolution.domain.ElectronicDocumentType documentType) {
    return jpaRepository.countActiveByCompanyBranchAndType(companyId, branchId, documentType.name())
        > 0;
  }
