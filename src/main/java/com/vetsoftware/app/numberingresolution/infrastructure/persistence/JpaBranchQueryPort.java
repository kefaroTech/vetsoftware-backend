...
/**
 * Adapter del {@link BranchQueryPort}: cruce permitido de vertical slicing (persistence →
 * persistence de branch) para validar que la sede de una resolución pertenezca a la empresa.
 */
