...
public class NumberingResolution {
    ...
    private static void validate(CompanyRef company, ElectronicDocumentType documentType,
        ...
        if (rangeTo < rangeFrom) throw new IllegalArgumentException("rangeTo must be greater than or equal to rangeFrom");
        ...
        if (validTo.isBefore(validFrom)) throw new IllegalArgumentException("validTo cannot be before validFrom");
