...
public class RolePermissionController {
  ...
  public RolePermissionController(
      CreateRolePermissionUseCase createUseCase,
  ...
  public List<RolePermissionResponse> syncByRole(
      @PathVariable Long roleId, @Valid @RequestBody SyncRolePermissionsRequest request) {
    return syncUseCase
        .execute(new SyncRolePermissionsCommand(roleId, request.permissionIds()))
        .stream()
        .map(this::toResponse)
        .toList();
  }
  ...
  public RolePermissionResponse update(
      @PathVariable Long id, @Valid @RequestBody UpdateRolePermissionRequest request) {
    return toResponse(
