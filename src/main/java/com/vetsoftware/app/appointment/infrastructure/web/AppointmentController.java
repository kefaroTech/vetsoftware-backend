...
public class AppointmentController {
  ...
  public AppointmentResponse update(
      @PathVariable Long id, @Valid @RequestBody UpdateAppointmentRequest request) {
    return toResponse(
  ...
  public AppointmentResponse changeStatus(
      @PathVariable Long id, @Valid @RequestBody ChangeAppointmentStatusRequest request) {
    return toResponse(
        changeStatusUseCase.execute(
            new ChangeAppointmentStatusCommand(id, request.status(), authz.currentCompanyId())));
  }

  @PatchMapping("/{id}/cancel")
  public AppointmentResponse cancel(
      @PathVariable Long id, @RequestBody(required = false) CancelAppointmentRequest request) {
    String reason = request == null ? null : request.reason();
    return toResponse(
        cancelUseCase.execute(new CancelAppointmentCommand(id, reason, authz.currentCompanyId())));
  }
