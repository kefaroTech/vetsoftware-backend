...
public class JpaAppointmentRepository implements AppointmentRepository {
  ...
  public Appointment save(Appointment appointment) {
    ...
    EmployeeJpaEntity employee =
        employeeJpaRepository.getReferenceById(appointment.getEmployee().id());
    ...
    AppointmentJpaEntity saved =
        jpaRepository.save(mapper.toJpa(appointment, animal, owner, employee, company, branch));
  ...
  public List<Appointment> findByFilters(
    ...
    return jpaRepository
        .findByFilters(companyId, from, to, employeeId, statusName, branchId)
        .stream()
        .map(mapper::toDomain)
        .toList();
  }
  ...
  @Override
  public List<Long> findClashingIds(
