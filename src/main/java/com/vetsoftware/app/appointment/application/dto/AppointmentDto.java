...
public record AppointmentDto(Long id, LocalDateTime startAt, AppointmentType type,
        AppointmentStatus status, String notes, String cancellationReason, AnimalSummaryDto animal,
        OwnerSummaryDto owner, String clientName, String clientPhone, String clientEmail,
        EmployeeSummaryDto employee, BranchSummaryDto branch, long version, boolean enabled,
    ...
    public static AppointmentDto from(Appointment a, List<Long> overlaps) {
        return new AppointmentDto(a.getId(), a.getStartAt(), a.getType(), a.getStatus(),
