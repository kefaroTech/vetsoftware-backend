...
public class Appointment {
    ...
    public Appointment(Long id, LocalDateTime startAt, AppointmentType type, AppointmentStatus status,
                       ...
                       String clientName, String clientPhone, String clientEmail, EmployeeRef employee,
                       CompanyRef company, BranchRef branch, long version, boolean enabled,
                       LocalDateTime createdDate) {
        validate(startAt, type, employee, company, branch, animal, owner, clientName, notes, clientPhone,
                 clientEmail, cancellationReason);
        this.id = id;
    ...
    public static Appointment create(LocalDateTime startAt, AppointmentType type, String notes,
                                     ...
                                     String clientEmail, EmployeeRef employee, CompanyRef company,
                                     BranchRef branch) {
        return new Appointment(null, startAt, type, AppointmentStatus.REQUESTED, notes, null,
                               animal, owner, clientName, clientPhone, clientEmail, employee, company, branch,
    ...
    public void update(LocalDateTime startAt, AppointmentType type, String notes, AnimalRef animal,
        ...
        validate(startAt, type, employee, this.company, this.branch, animal, owner, clientName, notes,
                 clientPhone, clientEmail, this.cancellationReason);
        this.startAt = startAt;
        this.type = type;
        this.notes = blankToNull(notes);
        this.animal = animal;
    ...
    private static void validate(LocalDateTime startAt, AppointmentType type, EmployeeRef employee,
        ...
        if (clientEmail != null && clientEmail.length() > 150) throw new IllegalArgumentException("clientEmail must be 150 chars or less");
