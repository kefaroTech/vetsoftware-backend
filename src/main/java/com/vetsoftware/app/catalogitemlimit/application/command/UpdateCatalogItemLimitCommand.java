 ...
 * igual que su hermano {@code UpdateBundleComponentCommand}. Sin él, el
 * {@code {catalogItemId}} de la ruta del {@code PUT} decoraría pero no se
 * comprobaría, y editar el techo del artículo 7 entrando por la ruta del 9
 * funcionaría. No sería una fuga entre empresas —aquí no hay empresas y el gate
 * es SYSTEM— pero sí una URL que miente, y una URL que miente es una URL que
 * alguien guarda y reutiliza. Con el campo dentro, la carga se acota por el par
 * y el desajuste responde 404.
 *
 * <p>
