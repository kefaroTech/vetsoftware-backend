...
public class Medicament {
    ...
    public Medicament(Long id, String name, String description,
    ...
    public static Medicament create(String name, String description, CompanyRef company, boolean general) {
    ...
    private static void validate(String name, String description, CompanyRef company, boolean general) {
        ...
        if (general && company != null) throw new IllegalArgumentException("general medicament cannot have company");
        if (!general && company == null) throw new IllegalArgumentException("non-general medicament requires company");
    }
