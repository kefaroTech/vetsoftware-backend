...
public interface ReactivateMedicamentUseCase {
     ...
     * {@link ReactivateGlobalMedicamentUseCase}. Los puertos de LECTURA de esta
     * slice conservan su {@code hasRole('SYSTEM')}: leer si esta permitido.
     */
    @PreAuthorize("hasAuthority('prescription.update')" + " and @authz.isMyCompany(#companyId)")
