...
/**
 * Edicion en el catalogo global. Sin {@code companyId} y sin {@code general},
 * por el mismo motivo que {@link CreateGlobalMedicamentRequest}: el ambito de
 * este endpoint es una constante, no un dato que viaje en el cuerpo.
 */
public record UpdateGlobalMedicamentRequest(
