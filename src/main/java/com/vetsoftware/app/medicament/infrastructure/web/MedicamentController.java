...
public class MedicamentController {
  ...
  public MedicamentController(
      CreateMedicamentUseCase createUseCase,
  ...
  public MedicamentResponse create(@Valid @RequestBody CreateMedicamentRequest request) {
    return toResponse(
        createUseCase.execute(
            new CreateMedicamentCommand(
                request.name(), request.description(), authz.currentCompanyId(), false)));
  }
  ...
  @PutMapping("/{id}")
  public MedicamentResponse update(
      @PathVariable Long id, @Valid @RequestBody UpdateMedicamentRequest request) {
    return toResponse(
