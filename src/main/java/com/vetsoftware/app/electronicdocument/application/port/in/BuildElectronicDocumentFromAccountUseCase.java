...
/**
 * F2: construye (no transmite) el documento desde una cuenta cerrada. Punto de
 * entrada PROVISIONAL para construir/probar el modelo; F4 reemplazara este
 * disparador manual por la emision al cerrar.
 */
