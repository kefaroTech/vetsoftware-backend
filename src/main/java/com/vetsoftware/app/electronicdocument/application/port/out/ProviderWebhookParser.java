...
/**
 * Interpreta el webhook de un proveedor async (p. ej. MATIAS). Cada proveedor
 * lo implementa con su formato de payload y su esquema de firma. El servicio
 * genérico enruta por {@link #providerName()}.
 */
public interface ProviderWebhookParser {
    String providerName();

    /**
     * Verifica la autenticidad del webhook (p. ej. HMAC-SHA256 del cuerpo crudo con
     * el secret).
     */
