 ...
 * (VALIDADO/RECHAZADO) o PENDIENTE (proveedores async como MATIAS, que completan luego por webhook
 * o por polling de estado). Campos de sellos vacíos hasta que el proveedor los devuelva.
 */
