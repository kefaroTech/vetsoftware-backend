...
public interface ElectronicInvoiceProviderPort {
    ...
    /**
     * Consulta el estado actual de un documento ya transmitido, para reconciliar los PENDIENTE cuando el
     * webhook de un proveedor asíncrono se pierde. Devuelve el {@link ProviderResult} normalizado, o vacío
     * si el proveedor no soporta polling (resuelve ya en {@link #transmit}).
     */
    default Optional<ProviderResult> fetchStatus(String providerDocumentKey, ProviderConfigSnapshot config) {
