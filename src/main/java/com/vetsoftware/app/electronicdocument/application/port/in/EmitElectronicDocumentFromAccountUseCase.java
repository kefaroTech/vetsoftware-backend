...
/**
 * F4: emite un documento electrónico desde una cuenta cerrada de extremo a
 * extremo (construir + transmitir + entregar PDF/QR/correo si valida). El tipo
 * (FE_VENTA / DOC_EQUIV_POS) lo elige el caller.
 */
