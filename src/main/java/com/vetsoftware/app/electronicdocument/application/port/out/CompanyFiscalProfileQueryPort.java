...
/**
 * Lee el perfil fiscal del emisor (CompanyTaxProfile) + sus tarifas de retencion (WithholdingConfig)
 * y los traduce al read model de esta feature. Unico punto que conoce esas otras features para el emisor.
 * Reutilizado tanto por el flujo de cuenta cerrada como por la venta directa de POS.
 */
