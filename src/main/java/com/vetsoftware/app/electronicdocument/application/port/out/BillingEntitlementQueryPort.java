 ...
 * submódulo con código BILLING. Cuando es false, los documentos se guardan localmente pero no se numeran
 * fiscalmente ni se transmiten al proveedor DIAN (MATIAS).
 */
