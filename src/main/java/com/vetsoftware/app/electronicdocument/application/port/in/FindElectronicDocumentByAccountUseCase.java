...
/**
 * Lee el documento electronico emitido al cerrar una cuenta (para imprimir su recibo). Disponible para
 * quien gestiona la cuenta (openAccount.read) o el modulo de facturacion (electronicDocument.read). Devuelve
