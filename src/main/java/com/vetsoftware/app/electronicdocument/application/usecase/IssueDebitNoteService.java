...
/**
 * Emite una nota debito (aumento) sobre una factura VALIDADA y la transmite. A
 * diferencia de la nota credito, NO reversa la cartera: solo aumenta el valor
...
public class IssueDebitNoteService implements IssueDebitNoteUseCase {
    ...
    public IssueDebitNoteService(ElectronicDocumentRepository repository,
    ...
    private ElectronicDocument buildPending(IssueDebitNoteCommand command) {
        ...
        if (original.isNote()) {
            throw new IllegalArgumentException(
                    "No se puede emitir una nota debito sobre otra nota.");
        }
        ...
        ElectronicDocument note = ElectronicDocument.createDebitNote(original,
