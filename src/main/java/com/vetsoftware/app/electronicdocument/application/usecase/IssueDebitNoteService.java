...
/**
 * Emite una nota debito (aumento) sobre una factura VALIDADA y la transmite. A diferencia de la
 * nota credito, NO reversa la cartera: solo aumenta el valor del documento referenciado.
 */
