 ...
 * Discrimina su tributo (categoria + esquema codificados) y monta
 * base/iva/total propios.
 */
public class ElectronicDocumentLine {
    ...
    /**
     * null solo en EXCLUIDO (sin esquema). EXENTO lleva esquema IVA (a tarifa 0%),
     * igual que GRAVADO/INC.
     */
    ...
    public ElectronicDocumentLine(Long id, int lineNumber, String description, BigDecimal quantity,
        ...
        if (quantity == null)
            throw new IllegalArgumentException("line quantity is required");
        ...
        if (lineExtensionAmount == null)
            throw new IllegalArgumentException("line lineExtensionAmount is required");
        if (taxCategory == null)
            throw new IllegalArgumentException("line taxCategory is required");
        if (taxAmount == null)
            throw new IllegalArgumentException("line taxAmount is required");
        if (totalAmount == null)
            throw new IllegalArgumentException("line totalAmount is required");
        this.id = id;
