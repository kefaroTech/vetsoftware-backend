...
/**
 * Linea del documento: foto congelada de un cargo no anulado de la cuenta. Discrimina su tributo
 * (categoria + esquema codificados) y monta base/iva/total propios.
 */
public class ElectronicDocumentLine {
  ...
  /**
   * null solo en EXCLUIDO (sin esquema). EXENTO lleva esquema IVA (a tarifa 0%), igual que
   * GRAVADO/INC.
   */
