...
/**
 * Concepto de correccion de la nota debito (catalogo DIAN §2.5), distinto al de la nota credito. El
 * codigo viaja en el XML UBL (DiscrepancyResponse/ResponseCode).
 */
