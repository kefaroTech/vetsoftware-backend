...
/**
 * Régimen de IVA del adquiriente congelado en el documento. Companion propio de
 * la feature (vertical slicing): no acopla al enum de {@code owner}. El
 * adaptador del proveedor (MATIAS) lo mapea al {@code tax_regime_id} de la
 * DIAN.
 */
public enum TaxRegime {
     ...
     * {@code customer_tax_regime}) de forma tolerante:
