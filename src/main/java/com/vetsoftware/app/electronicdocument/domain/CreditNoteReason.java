...
/**
 * Concepto de correccion de la nota credito (catalogo DIAN §2.5). El codigo viaja en el XML UBL
 * (DiscrepancyResponse/ResponseCode). NO confundir con el catalogo de la nota debito (DebitNoteReason).
 */
public enum CreditNoteReason {
    DEVOLUCION("1", "Devolución parcial o total de bienes/servicios"),
