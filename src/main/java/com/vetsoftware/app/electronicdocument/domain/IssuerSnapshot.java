...
/**
 * Copia congelada de la identidad fiscal del emisor al momento de emitir. No es una referencia viva
 * a CompanyTaxProfile: si el perfil cambia luego, el documento conserva esta copia.
 */
