...
/**
 * Cliente HTTP compartido para los proveedores DIAN. SIN base URL fija: cada llamada usa la URL
 * base de la config de la empresa (ProviderConfigSnapshot.baseUrl). Timeouts holgados porque la
 * transmisión al proveedor puede tardar.
 */
@Configuration
