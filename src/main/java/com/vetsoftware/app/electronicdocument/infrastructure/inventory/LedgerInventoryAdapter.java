...
/**
 * Adapter de orquestación POS → inventario. Es el ÚNICO punto de esta feature que conoce el {@code
 * StockLedgerUseCase} de {@code inventory}; traduce la venta/anulación POS a movimientos de kardex
 * con referencia {@link StockReferenceType#POS_DOCUMENT} y el id del documento (idempotencia +
 * compensación).
 */
