 ...
 * PromotionJpaEntity) y se queda con las ACTIVAS en la fecha dada (estado ACTIVE + hoy dentro del
 * rango [startDate, endDate]), espejando la derivacion de estado del front
 * (pricing.ts#promoStatus). Mapea a la forma local de SalePromotionQueryPort por nombre de enum
 * para no acoplar el dominio de promotion.
 */
@Component
