...
/**
 * Adapter: carga el Owner (scoped a la empresa) y lo congela en un
 * CustomerSnapshot, igual que el flujo de cuenta cerrada. Devuelve vacio si el
 * owner no existe o no es de la empresa.
 */
@Component
