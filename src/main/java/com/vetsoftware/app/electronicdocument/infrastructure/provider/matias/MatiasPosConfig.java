...
/**
 * B6 — Datos operativos del documento equivalente POS y del fabricante del software (Res.
 * 000165/2023), parametrizables por despliegue vía propiedades {@code vetsoftware.dian.pos.*} /
 * {@code .software.*} en vez de literales en el código. Los defaults conservan los valores previos
 * para no romper entornos existentes.
 */
@Component
