...
/**
 * Venta de POS a registrar. El front nunca manda companyId (lo deriva el backend del JWT). El
 * unitPrice de cada linea es el precio final (post-promo) con IVA incluido; la clasificacion
 * tributaria la pone el servidor desde el catalogo. customerOwnerId null o finalConsumer=true =>
 * consumidor final anonimo.
 */
public record RegisterPosSaleRequest(
  ...
  public record SalePaymentRequest(
      @NotNull PaymentMeans means, @NotNull @PositiveOrZero BigDecimal amount) {}
}
