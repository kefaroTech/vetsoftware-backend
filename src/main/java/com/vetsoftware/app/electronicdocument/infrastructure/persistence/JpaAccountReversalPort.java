...
/**
 * Adapter del {@link AccountReversalPort}: marca la cuenta abierta facturada como reversada cuando
 * su nota credito es validada por la DIAN. Cruce permitido (persistence -> persistence de otra
 * feature). Idempotente: no re-estampa una cuenta ya reversada ni falla si la cuenta no existe.
 */
@Component
