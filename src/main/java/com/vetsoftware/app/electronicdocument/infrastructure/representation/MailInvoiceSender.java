 ...
 * con copia al emisor. El envío es best-effort (el caller ya captura fallos);
 * el gate y el remitente los controla {@link ResendEmailClient}.
 */
@Component
public class MailInvoiceSender implements InvoiceMailPort {
    ...
    @Override
    public void send(String to, String cc, String subject, String htmlBody, String attachmentName,
            byte[] attachment) {
