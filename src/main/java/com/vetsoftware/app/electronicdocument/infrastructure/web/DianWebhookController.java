...
/**
 * Recibe webhooks de los proveedores async (p. ej. MATIAS) en {@code POST
 * /dian/webhooks/{provider}}. Ruta PÚBLICA (en AuthFilter.PUBLIC_PATHS): no
 * lleva JWT; su autenticidad es la firma HMAC que valida el servicio. Se recibe
 * el cuerpo CRUDO ({@code String}) para poder verificar el HMAC sobre los bytes
...
public class DianWebhookController {
    ...
    public void receive(@PathVariable String provider, @RequestBody String rawBody,
