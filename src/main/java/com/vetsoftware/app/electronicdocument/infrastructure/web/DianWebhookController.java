 ...
 * /dian/webhooks/{provider}}. Ruta PÚBLICA (en AuthFilter.PUBLIC_PATHS): no lleva JWT; su
 * autenticidad es la firma HMAC que valida el servicio. Se recibe el cuerpo CRUDO ({@code String})
 * para poder verificar el HMAC sobre los bytes exactos enviados por el proveedor.
 */
@RestController
