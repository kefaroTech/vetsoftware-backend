...
/**
 * Documento electronico (cabecera). INMUTABLE: sin @SQLDelete/@SQLRestriction
 * (nunca se soft-deletea ni edita; solo se corrige por nota credito/debito).
 * Snapshots de emisor/adquiriente como columnas.
 */
@Entity
...
public class ElectronicDocumentJpaEntity {
    ...
    // Sucursal emisora. Id pelado (sin @ManyToOne), igual que open_account_id /
    ...
    // Régimen de IVA del adquiriente congelado (RESPONSABLE_IVA /
    // NO_RESPONSABLE_IVA) → tax_regime_id
    // DIAN.
    @Column(name = "customer_tax_regime", length = 20)
    private String customerTaxRegime;

    // Responsabilidad fiscal del adquiriente congelada
    // (NO_APLICA/GRAN_CONTRIBUYENTE/…) →
    // tax_level_id DIAN.
    @Column(name = "customer_fiscal_responsibility", length = 20)
    private String customerFiscalResponsibility;
    ...
    // Set (no List) para permitir fetch conjunto via @EntityGraph sin
    ...
    // F5 - correcciones. Referencia al documento corregido (UBL BillingReference) +
    // concepto DIAN.
    // Pobladas solo en notas. `reversed` marca esta factura como anulada por una
    // nota credito
    // validada.
    ...
    // Idempotencia de la venta POS: UUID por apertura del cobro. UNIQUE(company_id,
    // client_request_id) evita
    ...
    // Actor fiscal (B8): empleado que emite el documento (POS/NC/ND). Id pelado sin
    // FK, igual que
    // open_account_id (cruce entre features por id). NULL en emisión al cierre,
    // procesos sistema y
    // legacy.
    ...
    public void setDianStatus(DianStatus dianStatus) {
    ...
    public void setIssuerDocumentType(String v) {
        this.issuerDocumentType = v;
    }

    public String getIssuerDocumentId() {
        return issuerDocumentId;
    }

    public void setIssuerDocumentId(String v) {
        this.issuerDocumentId = v;
    }

    public String getIssuerVerificationDigit() {
        return issuerVerificationDigit;
    }

    public void setIssuerVerificationDigit(String v) {
        this.issuerVerificationDigit = v;
    }
    ...
    public void setIssuerLegalName(String v) {
        this.issuerLegalName = v;
    }

    public String getIssuerTaxRegime() {
        return issuerTaxRegime;
    }

    public void setIssuerTaxRegime(String v) {
        this.issuerTaxRegime = v;
    }
    ...
    public void setIssuerEmail(String v) {
        this.issuerEmail = v;
    }

    public String getIssuerResponsibilities() {
        return issuerResponsibilities;
    }

    public void setIssuerResponsibilities(String v) {
        this.issuerResponsibilities = v;
    }
    ...
    public void setCustomerDocumentType(String v) {
        this.customerDocumentType = v;
    }
    ...
    public void setCustomerDocumentId(String v) {
        this.customerDocumentId = v;
    }

    public String getCustomerVerificationDigit() {
        return customerVerificationDigit;
    }

    public void setCustomerVerificationDigit(String v) {
        this.customerVerificationDigit = v;
    }
    ...
    public void setCustomerPersonType(String v) {
        this.customerPersonType = v;
    }
    ...
    public void setCustomerLegalName(String v) {
        this.customerLegalName = v;
    }
    ...
    public String getCustomerCityDane() {
        return customerCityDane;
    }

    public void setCustomerCityDane(String v) {
        this.customerCityDane = v;
    }
    ...
    public void setCustomerTaxRegime(String v) {
        this.customerTaxRegime = v;
    }

    public String getCustomerFiscalResponsibility() {
        return customerFiscalResponsibility;
    }

    public void setCustomerFiscalResponsibility(String v) {
        this.customerFiscalResponsibility = v;
    }
    ...
    public void setLineExtensionAmount(BigDecimal v) {
        this.lineExtensionAmount = v;
    }
    ...
    public void setTaxExclusiveAmount(BigDecimal v) {
        this.taxExclusiveAmount = v;
    }
    ...
    public void setTaxInclusiveAmount(BigDecimal v) {
        this.taxInclusiveAmount = v;
    }
    ...
    public void setPayableAmount(BigDecimal v) {
        this.payableAmount = v;
    }
    ...
    public void setReteFuenteAmount(BigDecimal v) {
        this.reteFuenteAmount = v;
    }
    ...
    public void setReteIvaAmount(BigDecimal v) {
        this.reteIvaAmount = v;
    }
    ...
    public void setReteIcaAmount(BigDecimal v) {
        this.reteIcaAmount = v;
    }
    ...
    public Set<ElectronicDocumentLineJpaEntity> getLines() {
        return lines;
    }

    public void setLines(Set<ElectronicDocumentLineJpaEntity> lines) {
        this.lines = lines;
    }

    public Set<ElectronicDocumentPaymentJpaEntity> getPayments() {
        return payments;
    }

    public void setPayments(Set<ElectronicDocumentPaymentJpaEntity> payments) {
        this.payments = payments;
    }

    public String getReferencedCufe() {
        return referencedCufe;
    }

    public void setReferencedCufe(String referencedCufe) {
        this.referencedCufe = referencedCufe;
    }

    public String getReferencedPrefix() {
        return referencedPrefix;
    }

    public void setReferencedPrefix(String referencedPrefix) {
        this.referencedPrefix = referencedPrefix;
    }

    public Long getReferencedNumber() {
        return referencedNumber;
    }

    public void setReferencedNumber(Long referencedNumber) {
        this.referencedNumber = referencedNumber;
    }

    public LocalDate getReferencedIssueDate() {
        return referencedIssueDate;
    }

    public void setReferencedIssueDate(LocalDate referencedIssueDate) {
        this.referencedIssueDate = referencedIssueDate;
    }
    ...
    public void setNoteReasonCode(String noteReasonCode) {
    ...
    public void setNoteReasonText(String noteReasonText) {
    ...
    public void setIssuedByEmployeeId(Long issuedByEmployeeId) {
