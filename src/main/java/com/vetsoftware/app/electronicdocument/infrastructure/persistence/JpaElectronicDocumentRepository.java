...
public class JpaElectronicDocumentRepository implements ElectronicDocumentRepository {
    ...
    public PageResult<ElectronicDocument> findAllByCompanyId(Long companyId, Long branchId,
        ...
        return Pages.result(ids, content);
    }
