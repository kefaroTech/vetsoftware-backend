...
/**
 * Adapter del {@link BranchInfoQueryPort}: cruce permitido de vertical slicing (persistence →
 * persistence de branch) para leer nombre/código/dirección de la sede emisora del POS.
 */
@Component
