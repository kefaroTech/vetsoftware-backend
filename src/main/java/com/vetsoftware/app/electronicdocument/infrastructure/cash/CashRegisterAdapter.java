...
/**
 * Adapter de orquestación POS → caja. Es el ÚNICO punto de esta feature que conoce el {@code
 * CashLedgerUseCase} de {@code cashregister}; traduce cada pago del documento ({@link
 * PaymentMeans}) al medio de caja ({@link CashPaymentMethod}) y registra el ingreso/compensación
 * con referencia {@link CashReferenceType#POS_DOCUMENT} y el id del documento (idempotencia +
 * compensación).
 */
