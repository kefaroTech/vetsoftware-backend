...
/**
 * Hoja de conteo físico: sede + líneas contadas por producto. {@code branchId} lo acota el
 * controller al alcance.
 */
public record RecordCountRequest(
    @NotNull Long branchId, String note, @NotEmpty @Valid List<Line> lines) {
