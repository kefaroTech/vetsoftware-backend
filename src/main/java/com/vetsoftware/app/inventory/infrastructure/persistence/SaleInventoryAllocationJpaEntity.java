...
/**
 * Fotografía append-only de la descomposición comercial a inventario. La definición vigente del combo nunca se usa
 * para reintentar ni revertir una venta histórica.
 */
@Entity
...
public class SaleInventoryAllocationJpaEntity {
    ...
    public void setReferenceType(StockReferenceType referenceType) { this.referenceType = referenceType; }
    public Long getReferenceId() { return referenceId; }
    public void setReferenceId(Long referenceId) { this.referenceId = referenceId; }
    public String getCommercialLineKey() { return commercialLineKey; }
    public void setCommercialLineKey(String commercialLineKey) { this.commercialLineKey = commercialLineKey; }
    public int getComponentSequence() { return componentSequence; }
    public void setComponentSequence(int componentSequence) { this.componentSequence = componentSequence; }
    public SellableItemType getSourceType() { return sourceType; }
    public void setSourceType(SellableItemType sourceType) { this.sourceType = sourceType; }
    public ProductPresentationJpaEntity getSourcePresentation() { return sourcePresentation; }
    public void setSourcePresentation(ProductPresentationJpaEntity sourcePresentation) { this.sourcePresentation = sourcePresentation; }
    public ProductBundleJpaEntity getSourceBundle() { return sourceBundle; }
    public void setSourceBundle(ProductBundleJpaEntity sourceBundle) { this.sourceBundle = sourceBundle; }
    public ProductPresentationJpaEntity getComponentPresentation() { return componentPresentation; }
    public void setComponentPresentation(ProductPresentationJpaEntity componentPresentation) { this.componentPresentation = componentPresentation; }
    public ProductJpaEntity getComponentProduct() { return componentProduct; }
    public void setComponentProduct(ProductJpaEntity componentProduct) { this.componentProduct = componentProduct; }
    public int getSourceQuantity() { return sourceQuantity; }
    public void setSourceQuantity(int sourceQuantity) { this.sourceQuantity = sourceQuantity; }
    public int getComponentQuantity() { return componentQuantity; }
    public void setComponentQuantity(int componentQuantity) { this.componentQuantity = componentQuantity; }
