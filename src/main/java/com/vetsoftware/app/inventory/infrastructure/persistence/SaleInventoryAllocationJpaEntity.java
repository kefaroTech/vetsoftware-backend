...
/**
 * Fotografía append-only de la descomposición comercial a inventario. La definición vigente del
 * combo nunca se usa para reintentar ni revertir una venta histórica.
 */
@Entity
