...
/**
 * Sesión de conteo físico (cíclico) de inventario en una sede. Agrupa las líneas contadas por
 * producto; al confirmarse, cada línea con {@link InventoryCountLine#difference()} distinta de cero
 * genera un ajuste en el ledger. Es el rastro de auditoría "qué se contó, quién y cuándo"; el
...
public class InventoryCount {
  ...
  public static InventoryCount create(
      Long companyId, Long branchId, String note, Long countedBy, List<InventoryCountLine> lines) {
    return new InventoryCount(
        null, companyId, branchId, note, countedBy, LocalDateTime.now(), true, lines);
  }
