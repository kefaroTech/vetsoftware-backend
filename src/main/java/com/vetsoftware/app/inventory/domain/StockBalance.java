...
/**
 * Saldo materializado por {@code (producto, sede)} = suma de los lotes disponibles de esa sede. Es el roll-up para
 * lectura rápida y el punto de serialización de las salidas concurrentes (lock optimista {@code version} + lectura
 * {@code FOR UPDATE} en la capa de persistencia). El costo NO vive aquí — vive en los lotes.
 */
public class StockBalance {
    ...
    public StockBalance(Long id, Long companyId, Long branchId, Long productId, int quantity, int minStock,
                        Long version) {
