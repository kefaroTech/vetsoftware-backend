...
/**
 * Asiento del kardex: append-only e inmutable (las correcciones son movimientos nuevos, nunca
 * UPDATE/DELETE). {@code quantity} lleva el signo según {@link StockMovementType#isInbound()}:
 * entradas +, salidas −.
 */
