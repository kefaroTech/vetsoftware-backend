...
/**
 * Lote de un producto en UNA sede: lleva el costo real de entrada
 * ({@code unitCost}) y el vencimiento para FEFO. El saldo disponible del lote
 * ({@code quantityAvailable}) es la parte materializada del kardex. FKs por id
 * plano (company/branch/product) — el inventario no necesita datos de esos
 * agregados, solo referenciarlos.
 */
public class StockLot {
    ...
    /**
     * Resta unidades del lote (salida). Puede dejar el lote en negativo si la
     * empresa permite stock negativo.
     */
