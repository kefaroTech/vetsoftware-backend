...
/**
 * Salida de una línea de conteo: sistema vs contado y la diferencia (ajuste)
 * resultante.
 */
public record InventoryCountLineView(Long productId, int systemQuantity, int countedQuantity,
        int difference) {
