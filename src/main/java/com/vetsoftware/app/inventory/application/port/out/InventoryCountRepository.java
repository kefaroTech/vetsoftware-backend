...
public interface InventoryCountRepository {
    /**
     * Persiste la sesión con sus líneas y devuelve el agregado con id y fecha
     * asignados.
     */
    InventoryCount save(InventoryCount count);

    /**
     * Listado paginado de sesiones (resumen, sin líneas) por empresa y sede
     * opcional, más reciente primero.
     */
