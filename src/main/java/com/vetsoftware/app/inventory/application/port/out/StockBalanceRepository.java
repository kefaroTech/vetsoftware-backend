...
public interface StockBalanceRepository {
  ...
  /**
   * Igual que {@link #find} pero con lock pesimista ({@code SELECT ... FOR UPDATE}): serializa las
   * salidas concurrentes del mismo producto en la misma sede para no sobrevender.
   */
