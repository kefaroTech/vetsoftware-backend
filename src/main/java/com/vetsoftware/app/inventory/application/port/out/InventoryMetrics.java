...
/**
 * Telemetría agregada del kardex. Nunca recibe empresa, sede, producto ni
 * referencia.
 */
public interface InventoryMetrics {
    ...
    enum Result {
        SUCCESS("success"), INSUFFICIENT_STOCK("insufficient_stock"), DUPLICATE_IGNORED(
                "duplicate_ignored"), VALIDATION_ERROR("validation_error");
