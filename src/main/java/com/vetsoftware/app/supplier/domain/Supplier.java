...
/**
 * Proveedor = ficha de un tercero al que la empresa le compra bienes o servicios (identidad,
 * contacto, condiciones comerciales). CRUD company-scoped: cada proveedor pertenece a una empresa y
 * su nombre es único entre los proveedores activos de esa empresa.
 */
