...
public class DeactivateBranchService implements DeactivateBranchUseCase {
  ...
  public BranchDto execute(Long id, Long companyId) {
    ...
    // No se puede desactivar la ÚLTIMA sede activa: dejaría a la empresa sin sede operativa y
    // bloquearía
    // las escrituras scopeadas (citas/cuentas/POS resuelven "sede activa por defecto"). Solo aplica
    // si la
    // sede está activa: desactivar una ya inactiva es idempotente y no reduce el número de sedes
    // activas.
