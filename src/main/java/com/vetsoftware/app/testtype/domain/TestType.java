...
public class TestType {
    ...
    public TestType(Long id, String name, String description,
    ...
    public static TestType create(String name, String description, CompanyRef company, boolean general) {
        return new TestType(null, name, description, company, general, LocalDateTime.now());
    }
