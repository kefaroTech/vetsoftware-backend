 ...
 */
public class DiagnosticImagingTypeNameAlreadyExistsException extends RuntimeException {
    public DiagnosticImagingTypeNameAlreadyExistsException(String name) {
        super("Ya existe un tipo de imagen diagnóstica activo con el nombre '" + name
                + "' en este ámbito.");
    }
}
