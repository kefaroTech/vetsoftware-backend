...
public interface DiagnosticImagingTypeJpaRepository
    ...
    @org.springframework.data.jpa.repository.Query(value = """
            SELECT *
            FROM diagnostic_imaging_types
            WHERE name = :name
              AND company_id = :companyId
            ORDER BY enabled DESC, id DESC
            LIMIT 1
            """, nativeQuery = true)
    Optional<DiagnosticImagingTypeJpaEntity> findByNameAndCompanyIncludingDisabled(
    ...
    @org.springframework.data.jpa.repository.Query(value = """
            ...
            LIMIT 1
            """, nativeQuery = true)
    Optional<DiagnosticImagingTypeJpaEntity> findGlobalByNameIncludingDisabled(
            @org.springframework.data.repository.query.Param("name") String name);
