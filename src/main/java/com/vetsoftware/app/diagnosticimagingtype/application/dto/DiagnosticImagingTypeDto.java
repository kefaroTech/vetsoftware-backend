...
public record DiagnosticImagingTypeDto(Long id, String name, String description,
    ...
    public static DiagnosticImagingTypeDto from(DiagnosticImagingType type) {
        return new DiagnosticImagingTypeDto(type.getId(), type.getName(), type.getDescription(),
                type.getCompany() == null ? null : CompanySummaryDto.from(type.getCompany()),
                type.isGeneral(), type.getCreatedDate(), type.isEnabled());
    }
}
