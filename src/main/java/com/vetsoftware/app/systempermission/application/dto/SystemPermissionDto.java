...
public record SystemPermissionDto(Long id, String name, String code, LocalDateTime createdDate, boolean enabled) {
    public static SystemPermissionDto from(SystemPermission systemPermission) {
        return new SystemPermissionDto(
            ...
            systemPermission.getName(),
            systemPermission.getCode(),
            systemPermission.getCreatedDate(),
