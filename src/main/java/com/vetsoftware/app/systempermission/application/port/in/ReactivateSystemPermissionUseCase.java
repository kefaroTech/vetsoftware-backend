...
/**
 * Alineado con sus hermanos —{@code CreateSystemPermissionUseCase},
 * {@code UpdateSystemPermissionUseCase}, {@code DeleteSystemPermissionUseCase}
 * y {@code FindSystemPermissionUseCase} son {@code hasRole('SYSTEM')} a secas—,
 * que es lo que este puerto debio ser siempre: llevaba
 * {@code hasAuthority('systempermission.update')} por copia del patron CRUD del
