...
public record CreateCompanyTaxProfileCommand(CompanyDocumentType companyDocumentType,
        String companyDocumentId, String companyDocumentVerificationDigit, String legalName,
        TaxRegime taxRegime, String fiscalEmail, String commercialName, Long economicActivityId,
        List<String> responsibilityCodes, Long companyId) {
}
