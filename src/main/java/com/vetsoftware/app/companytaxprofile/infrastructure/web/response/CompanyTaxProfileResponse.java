...
public record CompanyTaxProfileResponse(Long id, CompanySummary company,
        ...
        String fiscalEmail, String commercialName, EconomicActivitySummary economicActivity,
