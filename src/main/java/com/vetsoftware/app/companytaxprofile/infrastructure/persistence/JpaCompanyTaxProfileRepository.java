...
public class JpaCompanyTaxProfileRepository implements CompanyTaxProfileRepository {
  ...
  public JpaCompanyTaxProfileRepository(
      CompanyTaxProfileJpaRepository jpaRepository,
  ...
  public CompanyTaxProfile save(CompanyTaxProfile profile) {
    ...
    CompanyTaxProfileJpaEntity saved =
        jpaRepository.save(mapper.toJpa(profile, company, economicActivity));
