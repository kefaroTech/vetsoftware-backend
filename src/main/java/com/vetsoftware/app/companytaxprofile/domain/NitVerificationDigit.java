...
/**
 * Calcula el dígito de verificación (DV) de un NIT colombiano con el algoritmo de módulo 11 de la
 * DIAN. Los pesos se aplican de derecha a izquierda sobre los dígitos del NIT (sin incluir el
 * propio DV).
 */
public final class NitVerificationDigit {
   ...
   * @throws IllegalArgumentException si el NIT es nulo, vacío, no numérico o más largo que los
   *     pesos disponibles.
   */
