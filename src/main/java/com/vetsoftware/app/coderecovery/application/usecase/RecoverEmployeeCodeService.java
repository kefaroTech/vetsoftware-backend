...
/**
 * "Recordar mi código": busca todas las cuentas activas y verificadas con ese
 * correo y le envía sus códigos de acceso (una fila por veterinaria).
 * Anti-enumeración: si no hay coincidencias, termina sin error y sin enviar
 * nada. El código no es un secreto (es el usuario), pero solo se envía al
 * correo registrado.
 */
