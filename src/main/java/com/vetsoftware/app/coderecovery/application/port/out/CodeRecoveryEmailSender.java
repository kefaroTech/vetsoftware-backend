...
/**
 * Envía el correo con la lista de códigos de acceso (plantilla de Resend). La
 * implementación arma el bloque dinámico {@code ACCOUNTS_HTML} con una fila por
 * cuenta. Async/best-effort (no bloquea).
 */
