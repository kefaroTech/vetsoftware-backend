...
public class GoodsReceiptJpaMapper {
  ...
  /**
   * Write path: arma la entidad reusando las referencias JPA (proxies via getReferenceById) que le
   * pasa el repositorio; {@code productsById} mapea cada productId a su proxy.
   */
  public GoodsReceiptJpaEntity toJpa(
