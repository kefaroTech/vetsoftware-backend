...
/**
 * Recepción de mercancía (cabecera). {@code purchase_order_id} es una columna Long pelada
 * (sin @ManyToOne a la feature {@code purchaseorder}) para NO acoplar el modelo JPA; el enlace es
 * solo por id. Las líneas cuelgan por cascade + orphanRemoval.
 */
@Entity
...
public class GoodsReceiptJpaEntity {
  ...
  // Enlace por id a purchaseorder (columna simple, sin FK JPA para no acoplar el modelo entre
  // features).
