...
public class GoodsReceiptController {
  ...
  public GoodsReceiptController(
      CreateGoodsReceiptUseCase createUseCase,
  ...
  public PageResponse<GoodsReceiptResponse> search(
    ...
    PageResult<GoodsReceiptDto> result =
        searchUseCase.execute(
            new SearchGoodsReceiptsCommand(
  ...
  public GoodsReceiptResponse update(
      @PathVariable Long id, @Valid @RequestBody UpdateGoodsReceiptRequest request) {
    return toResponse(
  ...
  public GoodsReceiptResponse confirm(@PathVariable Long id) {
    return toResponse(
        confirmUseCase.execute(id, authz.currentCompanyId(), authz.currentEmployeeIdOrNull()));
  }
