...
public class GoodsReceiptLineJpaEntity {
    ...
    // Enlace por id a la línea de la orden de compra (columna simple, sin FK JPA). Null en recepción directa.
    ...
    public GoodsReceiptJpaEntity getGoodsReceipt() { return goodsReceipt; }
    public void setGoodsReceipt(GoodsReceiptJpaEntity goodsReceipt) { this.goodsReceipt = goodsReceipt; }
