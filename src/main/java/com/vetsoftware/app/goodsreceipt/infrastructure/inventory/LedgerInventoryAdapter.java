 ...
 * {@code StockLedgerUseCase} de {@code inventory}; traduce la entrada/reversión a movimientos de
 * kardex con referencia {@link StockReferenceType#GOODS_RECEIPT} y el id de la recepción
