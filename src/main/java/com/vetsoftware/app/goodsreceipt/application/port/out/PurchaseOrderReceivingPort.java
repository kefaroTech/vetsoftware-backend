...
/**
 * Registra/revierte lo recibido contra una orden de compra (feature {@code purchaseorder}) cuando la recepción
 * viene de una orden. El adapter de orquestación traduce a {@code ReceivePurchaseOrderUseCase}.
 */
public interface PurchaseOrderReceivingPort {

    /** Aplica las cantidades recibidas a las líneas de la orden de compra (avanza su estado de recepción). */
