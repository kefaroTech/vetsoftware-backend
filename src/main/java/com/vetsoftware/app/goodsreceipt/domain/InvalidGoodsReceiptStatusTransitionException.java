...
/**
 * Transición de estado no permitida (p.ej. editar/confirmar fuera de DRAFT, o
 * cancelar algo que no está CONFIRMED).
 */
public class InvalidGoodsReceiptStatusTransitionException extends RuntimeException {
    ...
    public InvalidGoodsReceiptStatusTransitionException(GoodsReceiptStatus from,
            GoodsReceiptStatus to) {
