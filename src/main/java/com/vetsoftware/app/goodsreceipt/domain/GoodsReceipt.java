...
/**
 * Recepción de mercancía = ingreso físico de bienes de un proveedor a una sede (con o sin orden de
 * compra previa). Agregado company-scoped con líneas por producto/lote. Se crea en DRAFT
 * (editable); al CONFIRMAR afecta el inventario (kardex por sede) y, si viene de una orden de
 * compra, registra lo recibido en ella; al CANCELAR se revierte todo. La transición de estado es la
 * guarda de idempotencia frente al ledger de inventario.
 */
