...
/**
 * Línea de una recepción de mercancía: qué producto entró, en qué lote/vencimiento, cuánto y a qué
 * costo. {@code purchaseOrderLineId} enlaza (opcionalmente) a la línea de la orden de compra para
 * recepción parcial.
 */
public class GoodsReceiptLine {
  ...
  public static GoodsReceiptLine create(
    ...
    return new GoodsReceiptLine(
        null, product, purchaseOrderLineId, lotNumber, expireDate, quantityReceived, unitCost);
  }

  private static void validate(
      ProductRef product, String lotNumber, int quantityReceived, BigDecimal unitCost) {
