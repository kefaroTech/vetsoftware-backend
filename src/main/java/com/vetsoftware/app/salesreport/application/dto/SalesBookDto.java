...
/**
 * Libro/registro de ventas (F6): una entrada por documento + desglose de impuesto por tarifa
 * (insumo formulario 300) + recaudo por medio de pago codificado DIAN + totales del periodo.
 */
