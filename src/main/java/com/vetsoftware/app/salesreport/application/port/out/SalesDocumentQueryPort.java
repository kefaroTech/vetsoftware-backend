...
/**
 * Lee los documentos electrónicos de una empresa para los reportes contables (F6). Vista de solo lectura
 * en tipos propios de esta feature (String/BigDecimal): no acopla salesreport al dominio de electronicdocument.
 */
public interface SalesDocumentQueryPort {
    ...
    record TaxLineView(String taxScheme, BigDecimal taxRate, BigDecimal taxableAmount, BigDecimal taxAmount) {}
