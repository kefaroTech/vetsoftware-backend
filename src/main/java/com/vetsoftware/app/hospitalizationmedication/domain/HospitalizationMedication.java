...
public class HospitalizationMedication {
  ...
  public HospitalizationMedication(
      Long id,
      String name,
      String dose,
      Frequency frequency,
  ...
  public static HospitalizationMedication create(
      String name,
      String dose,
      Frequency frequency,
      GuidelineType guidelineType,
  ...
  private static void validate(
      String name, HospitalizationRef hospitalization, EmployeeRef createdBy) {
