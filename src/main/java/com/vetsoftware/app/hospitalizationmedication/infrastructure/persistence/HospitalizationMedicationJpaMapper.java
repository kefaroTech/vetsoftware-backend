...
public class HospitalizationMedicationJpaMapper {
  ...
  public HospitalizationMedicationJpaEntity toJpa(
    ...
    entity.setDurationMeasure(
        medication.getDurationMeasure() == null ? null : medication.getDurationMeasure().name());
  ...
  public HospitalizationMedication toDomain(HospitalizationMedicationJpaEntity entity) {
    ...
    EmployeeRef suspensionByRef =
        sb == null ? null : new EmployeeRef(sb.getId(), sb.getEmployeeCode(), sb.getName());
    return toDomain(
        entity,
  ...
  public HospitalizationMedication toDomain(
      HospitalizationMedicationJpaEntity entity,
