...
public interface HospitalizationMedicationJpaRepository
  ...
  @EntityGraph(attributePaths = {"hospitalization", "createdBy", "suspensionBy"})
  Optional<HospitalizationMedicationJpaEntity> findByIdAndHospitalization_Company_Id(
  ...
  @org.springframework.data.jpa.repository.Query(
      value = "UPDATE hospitalization_medications SET enabled = true WHERE id = :id",
      nativeQuery = true)
