...
public class HospitalizationMedicationController {
  ...
  public HospitalizationMedicationController(
      CreateHospitalizationMedicationUseCase createUseCase,
  ...
  public HospitalizationMedicationResponse create(
    ...
    return toResponse(
        createUseCase.execute(
            new CreateHospitalizationMedicationCommand(
                request.name(),
                request.dose(),
                request.frequency(),
  ...
  @PutMapping("/{id}")
  public HospitalizationMedicationResponse update(
      @PathVariable Long id, @Valid @RequestBody UpdateHospitalizationMedicationRequest request) {
    return toResponse(
        updateUseCase.execute(
            new UpdateHospitalizationMedicationCommand(
                id,
                request.name(),
                request.dose(),
                request.frequency(),
