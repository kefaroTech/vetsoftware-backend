...
public record EconomicActivityDto(Long id, String code, String name, LocalDateTime createdDate,
        boolean enabled) {
    public static EconomicActivityDto from(EconomicActivity economicActivity) {
        return new EconomicActivityDto(economicActivity.getId(), economicActivity.getCode(),
                economicActivity.getName(), economicActivity.getCreatedDate(),
