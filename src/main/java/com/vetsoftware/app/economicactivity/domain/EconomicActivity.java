...
public class EconomicActivity {
    ...
    public EconomicActivity(Long id, String code, String name, LocalDateTime createdDate, boolean enabled) {
        if (code == null || code.isBlank()) throw new IllegalArgumentException("code is required");
        if (code.length() > 20) throw new IllegalArgumentException("code must be 20 chars or less");
