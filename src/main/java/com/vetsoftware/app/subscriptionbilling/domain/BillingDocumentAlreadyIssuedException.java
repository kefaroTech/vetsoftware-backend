 ...
 *
 * <p>
 * <b>Que se rompe si esto no existe.</b> Lo que dice VetSoftware deja de
 * coincidir con lo que tiene la DIAN y no hay forma de saber cual de los dos
 * miente. Cuando {@code issue_status = 'EXTERNAL_REGISTERED'} solo cambian lo
 * saldado, el saldo -que es columna calculada- y el estado; el importe, el
 * periodo y el tipo quedan sellados. Corregirlos exige una nota credito emitida
 * fuera y registrada aqui, encadenada al original por
