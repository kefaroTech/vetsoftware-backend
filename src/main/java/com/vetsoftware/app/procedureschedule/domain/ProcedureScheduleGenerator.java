...
/**
 * Servicio de dominio puro: genera las ejecuciones (ProcedureSchedule) de una orden de
 * procedimiento a partir de su frecuencia, duración y hora de inicio. Sin dependencias de Spring ni
 * de infraestructura.
 */
public final class ProcedureScheduleGenerator {
  ...
  public static List<ProcedureSchedule> generate(
      ProcedureOrderParams params, EmployeeRef createdBy) {
    ...
    HospitalizationProcedureRef ref = new HospitalizationProcedureRef(params.id(), params.name());
   ...
   * FIJA (o INTERVALO sin aplicadas): horas de reloj saltando las primeras `appliedCount`. - DOSES:
   * pendientes = total - appliedCount (nunca negativo).
   */
  public static List<ProcedureSchedule> generatePending(
      ProcedureOrderParams params,
      int appliedCount,
  ...
  private static ProcedureSchedule slotAt(
      HospitalizationProcedureRef ref, LocalDateTime dt, EmployeeRef createdBy) {
