...
public interface ProcedureScheduleJpaRepository
  ...
  @org.springframework.data.jpa.repository.Query(
      value =
          "UPDATE procedure_schedules SET enabled = false WHERE hospitalization_procedure_id ="
              + " :procedureId AND enabled = true",
      nativeQuery = true)
  ...
  @org.springframework.transaction.annotation.Transactional
  @org.springframework.data.jpa.repository.Query(
      value = "UPDATE procedure_schedules SET enabled = true WHERE id = :id",
      nativeQuery = true)
