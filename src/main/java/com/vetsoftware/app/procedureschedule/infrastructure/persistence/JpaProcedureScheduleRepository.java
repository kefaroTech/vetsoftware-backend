...
public class JpaProcedureScheduleRepository implements ProcedureScheduleRepository {
  ...
  public JpaProcedureScheduleRepository(
      ProcedureScheduleJpaRepository jpaRepository,
  ...
  public ProcedureSchedule save(ProcedureSchedule procedureSchedule) {
    HospitalizationProcedureJpaEntity hospitalizationProcedure =
        hospitalizationProcedureJpaRepository.getReferenceById(
            procedureSchedule.getHospitalizationProcedure().id());
    ...
    return mapper.toDomain(
        saved, procedureSchedule.getHospitalizationProcedure(), procedureSchedule.getCreatedBy());
  }
