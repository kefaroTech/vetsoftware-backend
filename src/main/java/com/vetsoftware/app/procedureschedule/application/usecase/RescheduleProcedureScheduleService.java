...
public class RescheduleProcedureScheduleService implements RescheduleProcedureScheduleUseCase {
  ...
  public RescheduleProcedureScheduleService(
  ...
  public List<ProcedureScheduleDto> execute(RescheduleProcedureScheduleCommand command) {
    ...
    List<ProcedureSchedule> all =
        new ArrayList<>(repository.findByHospitalizationProcedureId(procedureId));
  ...
  private void recalcFollowing(
      List<ProcedureSchedule> all, int pivotIdx, LocalDateTime from, int intervalHours) {
