 ...
 * 404 corriente de una consola; aquella dice «Lumbre no tiene identidad fiscal
 * vigente», que es un fallo de configuracion del producto entero. Fundirlas en
 * una sola haria que el segundo caso —el grave— llegara disfrazado del primero.
 */
