...
public class JpaDebtOpenAccountRepository implements DebtOpenAccountRepository {
  ...
  public JpaDebtOpenAccountRepository(
      DebtOpenAccountJpaRepository jpaRepository,
  ...
  public DebtOpenAccount save(DebtOpenAccount debtOpenAccount) {
    ...
    return mapper.toDomain(
        saved,
        debtOpenAccount.getOpenAccount(),
        debtOpenAccount.getCreatedBy(),
        debtOpenAccount.getVoidedBy());
  }
  ...
  @Override
  public Optional<DebtOpenAccount> findByOpenAccountIdAndClientRequestId(
