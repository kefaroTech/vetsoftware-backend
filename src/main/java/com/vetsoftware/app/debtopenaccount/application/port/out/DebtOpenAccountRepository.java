...
public interface DebtOpenAccountRepository {
  ...
  /**
   * Lectura scoped a la empresa (vía la cuenta): evita IDOR cross-tenant al consultar un abono por
   * id directo.
   */
  ...
  Optional<DebtOpenAccount> findByOpenAccountIdAndClientRequestId(
