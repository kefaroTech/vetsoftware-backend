...
public interface OpenAccountQueryPort {
   ...
   * + guard de sobrepago + recálculo) y no solo durante el recálculo. Debe invocarse como primera
   * sentencia del caso de uso. No-op si la cuenta no existe (la validación posterior lo reporta).
   */
