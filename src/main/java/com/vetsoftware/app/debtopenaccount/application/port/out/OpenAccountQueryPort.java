...
public interface OpenAccountQueryPort {
    ...
    /**
     * Toma el bloqueo pesimista (FOR UPDATE) sobre la cuenta al inicio de la operación, para serializar
     * cargos/abonos concurrentes desde el read-modify-write completo (validación de estado + guard de
     * sobrepago + recálculo) y no solo durante el recálculo. Debe invocarse como primera sentencia del
     * caso de uso. No-op si la cuenta no existe (la validación posterior lo reporta).
     */
