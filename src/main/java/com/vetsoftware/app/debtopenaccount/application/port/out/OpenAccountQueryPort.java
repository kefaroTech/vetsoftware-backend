...
public interface OpenAccountQueryPort {
     ...
     * {@link #findById(Long)} y comparar la empresa despues en Java deja el abono
     * escrito en la cuenta de otro tenant en cuanto ese {@code if} se mueva o se
     * copie sin el (BE-COV,
     ...
     * read-modify-write completo (validación de estado + guard de sobrepago +
     * recálculo) y no solo durante el recálculo. Debe invocarse como primera
     * sentencia del caso de uso. No-op si la cuenta no existe (la validación
     * posterior lo reporta).
     *
     * <p>
