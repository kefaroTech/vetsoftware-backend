...
@Table(
    ...
    uniqueConstraints = {
      @UniqueConstraint(
          name = "uq_base_role_permissions",
          columnNames = {"base_role_id", "base_permission_id"})
    })
...
public class BaseRolePermissionJpaEntity {
  ...
  public BaseRoleJpaEntity getBaseRole() {
    return baseRole;
  }

  public void setBaseRole(BaseRoleJpaEntity baseRole) {
    this.baseRole = baseRole;
  }

  public BasePermissionJpaEntity getBasePermission() {
    return basePermission;
  }

  public void setBasePermission(BasePermissionJpaEntity basePermission) {
