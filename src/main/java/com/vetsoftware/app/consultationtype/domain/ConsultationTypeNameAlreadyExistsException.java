 ...
 */
public class ConsultationTypeNameAlreadyExistsException extends RuntimeException {
    public ConsultationTypeNameAlreadyExistsException(String name) {
        super("Ya existe un tipo de consulta activo con el nombre '" + name
                + "' en este catálogo.");
    }
}
