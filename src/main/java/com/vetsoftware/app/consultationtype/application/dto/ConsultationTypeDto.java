...
public record ConsultationTypeDto(Long id, String name, String description,
        LocalDateTime createdDate, boolean enabled) {
    public static ConsultationTypeDto from(ConsultationType consultationType) {
        return new ConsultationTypeDto(consultationType.getId(), consultationType.getName(),
                consultationType.getDescription(), consultationType.getCreatedDate(),
