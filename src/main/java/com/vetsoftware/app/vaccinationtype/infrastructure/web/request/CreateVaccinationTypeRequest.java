...
public record CreateVaccinationTypeRequest(
        @NotBlank(message = "El nombre del tipo de vacuna es obligatorio.") @Size(max = 100, message = "El nombre del tipo de vacuna no puede superar los 100 caracteres.") String name,
