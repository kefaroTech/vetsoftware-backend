...
public class JpaVaccinationTypeRepository implements VaccinationTypeRepository {
    ...
    @Override
    public Optional<VaccinationType> findOwnedByIdAndCompanyId(Long id, Long companyId) {
    ...
    @Override
    public Optional<VaccinationType> findByNameAndCompanyIdIncludingDisabled(String name,
            Long companyId) {
