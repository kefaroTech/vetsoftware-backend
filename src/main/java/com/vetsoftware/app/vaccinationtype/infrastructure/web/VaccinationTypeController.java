...
public class VaccinationTypeController {
  ...
  public VaccinationTypeController(
      CreateVaccinationTypeUseCase createUseCase,
  ...
  public VaccinationTypeResponse create(@Valid @RequestBody CreateVaccinationTypeRequest request) {
    return toResponse(
        createUseCase.execute(
            new CreateVaccinationTypeCommand(
                request.name(),
                request.description(),
  ...
  @PutMapping("/{id}")
  public VaccinationTypeResponse update(
      @PathVariable Long id, @Valid @RequestBody UpdateVaccinationTypeRequest request) {
    return toResponse(
        updateUseCase.execute(
            new UpdateVaccinationTypeCommand(
                id,
                request.name(),
                request.description(),
                authz.currentCompanyId(),
