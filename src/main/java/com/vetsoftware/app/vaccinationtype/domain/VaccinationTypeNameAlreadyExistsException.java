 ...
 */
public class VaccinationTypeNameAlreadyExistsException extends RuntimeException {
    public VaccinationTypeNameAlreadyExistsException(String name) {
        super("Ya existe un tipo de vacuna activo con el nombre '" + name + "' en este ámbito.");
    }
}
