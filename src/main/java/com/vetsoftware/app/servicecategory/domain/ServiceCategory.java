...
public class ServiceCategory {
  ...
  public static ServiceCategory create(String name, String description, CompanyRef company) {
    return new ServiceCategory(
        null, name, description, company, LocalDateTime.now(), null, null, null, true);
  }

  public void update(
      String name, String description, CompanyRef company, Long updatedBy, Long expectedVersion) {
    validate(name, description, company);
    this.name = name;
    this.description = description;
    this.company = company;
