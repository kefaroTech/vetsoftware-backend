...
public class ServiceCategory {
    ...
    public ServiceCategory(Long id, String name, String description, CompanyRef company,
    ...
    public static ServiceCategory create(String name, String description, CompanyRef company) {
        return new ServiceCategory(null, name, description, company, LocalDateTime.now(), null,
                null, null, true);
    }
