...
public class BaseRole {
    ...
    public BaseRole(Long id, String name, String code, Boolean mandatory, LocalDateTime createdDate, boolean enabled) {
        ...
        if (mandatory == null) throw new IllegalArgumentException("mandatory is required");
        this.id = id;
        this.name = name;
        this.code = code;
