...
public class BaseRoleController {
  ...
  public BaseRoleController(
      CreateBaseRoleUseCase createUseCase,
  ...
  @PutMapping("/{id}")
  public BaseRoleResponse update(
      @PathVariable Long id, @Valid @RequestBody UpdateBaseRoleRequest request) {
    return toResponse(
  ...
  private BaseRoleResponse toResponse(BaseRoleDto dto) {
    return new BaseRoleResponse(
        dto.id(), dto.name(), dto.code(), dto.mandatory(), dto.createdDate(), dto.enabled());
  }
}
