...
public record UpdateOwnerRequest(@NotBlank @Size(max = 150) String name,
        @Email @Size(max = 150) String email, @NotBlank @Size(max = 50) String document,
        @NotNull OwnerDocumentType documentType, @NotNull PersonType personType,
        @Size(max = 1) String verificationDigit, @Size(max = 255) String legalName,
        @Size(max = 255) String address, @Size(max = 30) String phone, @NotNull Long cityId,
