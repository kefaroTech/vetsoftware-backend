...
@Table(
    ...
    uniqueConstraints = {
      @UniqueConstraint(
          name = "uq_owners_company_document",
...
public class OwnerJpaEntity {
  ...
  // Régimen de IVA del adquiriente → tax_regime_id ante la DIAN (RESPONSABLE_IVA=1 /
  ...
  // Responsabilidad fiscal del adquiriente → tax_level_id (TaxLevelCode) ante la DIAN. Default
  // NO_APLICA.
  @Enumerated(EnumType.STRING)
