...
public class Owner {
  ...
  // F6 - agente retenedor: cuando el adquiriente lo es, la factura calcula y muestra sus
  // retenciones.
  private boolean withholdingAgent;
  // Régimen de IVA del adquiriente (responsable / no responsable): determina el tax_regime_id ante
  // la DIAN.
  private TaxRegime taxRegime;
  // Responsabilidad fiscal del adquiriente (RUT): determina el tax_level_id (TaxLevelCode) ante la
  // DIAN.
