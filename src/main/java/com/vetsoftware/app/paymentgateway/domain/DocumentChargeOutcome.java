...
public enum DocumentChargeOutcome {
    APPROVED, PENDING, DECLINED, SKIPPED_NO_BALANCE, SKIPPED_PENDING_PAYMENT, SKIPPED_HARD_DECLINE, SKIPPED_BUDGET, SKIPPED_NOT_DUE, SKIPPED_VOIDED, NO_PAYMENT_METHOD, NOT_CONFIGURED
}
