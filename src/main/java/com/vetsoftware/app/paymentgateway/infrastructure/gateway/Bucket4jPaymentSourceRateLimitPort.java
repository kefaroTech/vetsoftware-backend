...
/**
 * Reutiliza el bucket4j-sobre-Redis ya cableado para el rate limiting de login
 * ({@code RateLimitConfig}): mismo mecanismo distribuido, cubo propio por
 * empresa.
 *
 * <p>
...
public class Bucket4jPaymentSourceRateLimitPort implements PaymentSourceRateLimitPort {
    ...
    public Bucket4jPaymentSourceRateLimitPort(
