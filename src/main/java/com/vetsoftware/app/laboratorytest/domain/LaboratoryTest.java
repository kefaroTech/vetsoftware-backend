...
public class LaboratoryTest {
    ...
    public LaboratoryTest(Long id, LocalDate date, TestTypeRef testType, Integer quantity,
                          String diagnosis, AnimalRef animal, CompanyRef company,
                          LocalDateTime createdDate) {
        validate(date, testType, quantity, diagnosis, animal, company);
        this.id = id;
        this.date = date;
    ...
    public static LaboratoryTest create(LocalDate date, TestTypeRef testType, Integer quantity,
                                        String diagnosis, AnimalRef animal, CompanyRef company) {
        return new LaboratoryTest(null, date, testType, quantity, diagnosis, animal, company,
                                  LocalDateTime.now());
    }
