...
public class LaboratoryTestController {
  ...
  public LaboratoryTestController(
      CreateLaboratoryTestUseCase createUseCase,
  ...
  @PutMapping("/{id}")
  public LaboratoryTestResponse update(
      @PathVariable Long id, @Valid @RequestBody UpdateLaboratoryTestRequest request) {
    return toResponse(
  ...
  public LaboratoryTestResponse changeStatus(
      @PathVariable Long id, @Valid @RequestBody ChangeLaboratoryTestStatusRequest request) {
    return toResponse(
        changeStatusUseCase.execute(
            new ChangeLaboratoryTestStatusCommand(
                id, request.status(), authz.currentEmployeeIdOrNull())));
  }
