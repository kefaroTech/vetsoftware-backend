 ...
 */
public class LaboratoryTestTypeNameAlreadyExistsException extends RuntimeException {
    public LaboratoryTestTypeNameAlreadyExistsException(String name) {
        super("Ya existe un tipo de examen de laboratorio activo con el nombre '" + name
                + "' en este ámbito.");
    }
}
