...
public class LaboratoryTestTypeController {
  ...
  public LaboratoryTestTypeController(
      CreateLaboratoryTestTypeUseCase createUseCase,
  ...
  public LaboratoryTestTypeResponse create(
    ...
    return toResponse(
        createUseCase.execute(
            new CreateLaboratoryTestTypeCommand(
                request.name(),
                request.description(),
  ...
  @PutMapping("/{id}")
  public LaboratoryTestTypeResponse update(
      @PathVariable Long id, @Valid @RequestBody UpdateLaboratoryTestTypeRequest request) {
    return toResponse(
        updateUseCase.execute(
            new UpdateLaboratoryTestTypeCommand(
                id,
                request.name(),
                request.description(),
                authz.currentCompanyId(),
