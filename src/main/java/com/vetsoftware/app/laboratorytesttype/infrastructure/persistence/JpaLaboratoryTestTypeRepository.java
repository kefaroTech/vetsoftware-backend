...
public class JpaLaboratoryTestTypeRepository implements LaboratoryTestTypeRepository {
  ...
  public JpaLaboratoryTestTypeRepository(
      LaboratoryTestTypeJpaRepository jpaRepository,
  ...
  public LaboratoryTestType save(LaboratoryTestType laboratoryTestType) {
    ...
    LaboratoryTestTypeJpaEntity saved =
        jpaRepository.save(mapper.toJpa(laboratoryTestType, company));
