...
public class LaboratoryTestFileJpaMapper {
  ...
  public LaboratoryTestFileJpaEntity toJpa(
  ...
  public LaboratoryTestFile toDomain(
      LaboratoryTestFileJpaEntity entity,
      EmployeeRef uploadedByRef,
      LaboratoryTestRef laboratoryTestRef) {
