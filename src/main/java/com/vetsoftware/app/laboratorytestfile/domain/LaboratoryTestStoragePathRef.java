...
public record LaboratoryTestStoragePathRef(Long companyId, Long ownerId, Long animalId, String animalName) {
    public LaboratoryTestStoragePathRef {
        ...
        if (animalName == null || animalName.isBlank()) throw new IllegalArgumentException("animalName is required");
    }
}
