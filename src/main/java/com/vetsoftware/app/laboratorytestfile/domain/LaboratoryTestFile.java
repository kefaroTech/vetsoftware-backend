...
public class LaboratoryTestFile {
    ...
    public LaboratoryTestFile(Long id, String storageKey, String bucket, String originalFileName,
        ...
        validate(storageKey, bucket, originalFileName, contentType, sizeBytes, eTag, uploadedBy,
                laboratoryTest);
        this.id = id;
    ...
    public static LaboratoryTestFile create(String storageKey, String bucket,
    ...
    private static void validate(String storageKey, String bucket, String originalFileName,
        ...
        if (storageKey.length() > 512)
            throw new IllegalArgumentException("storageKey must be 512 chars or less");
        if (bucket == null || bucket.isBlank())
            throw new IllegalArgumentException("bucket is required");
        if (originalFileName == null || originalFileName.isBlank())
            throw new IllegalArgumentException("originalFileName is required");
        if (originalFileName.length() > 255)
            throw new IllegalArgumentException("originalFileName must be 255 chars or less");
        ...
        if (laboratoryTest == null)
            throw new IllegalArgumentException("laboratoryTest is required");
    }
    ...
    public EmployeeRef getUploadedBy() {
        return uploadedBy;
    }

    public LaboratoryTestRef getLaboratoryTest() {
