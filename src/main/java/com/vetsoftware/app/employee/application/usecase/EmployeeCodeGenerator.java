 ...
 * {@code PREFIJO(iniciales de la empresa)-SUFIJO(nombre sin espacios, máx 10)}. El admin puede
 * editar la sugerencia; {@link #generateAvailable} garantiza que esté libre en el momento de
 * proponerla (sufijo -2, -3…).
 */
final class EmployeeCodeGenerator {
  ...
  static String generateAvailable(
      String companyName, String employeeName, Predicate<String> taken) {
