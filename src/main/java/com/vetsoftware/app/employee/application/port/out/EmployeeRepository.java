...
public interface EmployeeRepository {
  ...
  /** Búsqueda paginada por empresa (nombre/código/correo), incluyendo desactivados. */
  ...
  /**
   * ¿Existe ya ese código de empleado? Cuenta TODAS las filas (incluidas las desactivadas), acorde
   * a la constraint unique de la BD, para validar disponibilidad al autogenerar/editar el código.
   */
