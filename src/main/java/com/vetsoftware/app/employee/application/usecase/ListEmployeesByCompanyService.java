...
public class ListEmployeesByCompanyService implements ListEmployeesByCompanyUseCase {
    ...
    public List<EmployeeDto> listByCompany(Long companyId) {
        // Incluye desactivados: la pantalla muestra el estado
        // (Activo/Inactivo/Invitado).
        ...
        // Para el listado: los desactivados muestran el rol que tenían (asignaciones
        // aunque
        // deshabilitadas).
        Map<Long, List<RoleSnapshot>> rolesByEmployee = rolesQueryPort.findRolesForListing(ids);
        // Sedes asignadas (batch por ids) para poder filtrar p.ej. los veterinarios por
        // sede en la
        // agenda.
