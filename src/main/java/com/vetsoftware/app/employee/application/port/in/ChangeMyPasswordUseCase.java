...
/**
 * Cambia la contraseña del propio empleado autenticado y limpia
 * {@code mustChangePassword}.
 */
public interface ChangeMyPasswordUseCase {
    /**
     * @return {@code true} si era un cambio forzado de primer login
     *         (mustChangePassword estaba en true), es decir, el empleado acaba de
