...
public interface ChangeMyPasswordUseCase {
  /**
   * @return {@code true} si era un cambio forzado de primer login (mustChangePassword estaba en
   *     true), es decir, el empleado acaba de <b>aceptar su invitación</b>; {@code false} si era un
   *     cambio voluntario.
   */
