...
/**
 * Companion VO de una sede ({@code branch}) referenciada por un empleado. La feature {@code employee} no importa el
 * dominio de {@code branch}: solo guarda los campos que necesita mostrar (id + nombre) en su listado/detalle.
 */
