...
public class Employee {
  ...
  /**
   * Crea un empleado nuevo. {@code emailVerified=false} para el dueño por auto-registro (Opción B,
   * debe verificar el correo antes de entrar). {@code mustChangePassword=true} para el staff
   * invitado por un admin (se le asigna una contraseña temporal y debe cambiarla en el primer
   * login). En ese caso arranca en {@code INVITED} y pasará a {@code ACTIVE} en su primer login; el
   * dueño auto-registrado arranca ACTIVE.
   */
  ...
  /**
   * Cambia la contraseña (hash ya calculado) y limpia la obligación de cambiarla en el primer
   * login.
   */
   ...
   * obligación de cambio e <b>invalida las sesiones vivas</b> subiendo authVersion (el usuario no
   * está logueado; cualquier sesión abierta debe caerse por seguridad).
   */
  ...
  /**
   * Marca el empleado como activo (primer login). Idempotente: activar dos veces no tiene efecto
   * adicional.
   */
  ...
  /**
   * Reenvía la invitación: asigna una nueva contraseña temporal (hash ya calculado), vuelve a
   * exigir el cambio en el primer login y deja el estado en INVITED. La contraseña previa ya estaba
   * ofuscada en hash, por eso el admin escribe una nueva provisional.
   */
