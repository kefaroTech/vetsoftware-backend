...
/**
 * Correo de invitación de empleado enviado con una <b>plantilla de Resend</b> ({@code template: {
 * id, variables }}). Async y no bloqueante (si Resend falla, se registra un warning y el alta
 * continúa).
 *
