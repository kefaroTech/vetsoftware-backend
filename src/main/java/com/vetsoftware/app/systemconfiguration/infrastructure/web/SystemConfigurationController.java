...
/**
 * Configuración general del sistema (global, clave-valor; no scoped a empresa). Lectura para
 * cualquier autenticado; escritura (upsert por propertyName) solo admin/gestor. Controla ajustes
 * como el UVT.
 */
@RestController
...
public class SystemConfigurationController {
  ...
  public SystemConfigurationController(
      ListSystemConfigurationsUseCase listUseCase, SetSystemConfigurationUseCase setUseCase) {
