...
/**
 * Crea o actualiza (upsert por {@code propertyName}) una configuración general
 * del sistema. Es global (no por empresa), así que solo lo gestiona un
 * administrador. NOTA: `systemConfiguration.manage` aún Por su alcance global
 * no admite permisos empresariales granulares.
 */
