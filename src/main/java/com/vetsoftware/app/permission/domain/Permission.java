...
public class Permission {
    ...
    public Permission(Long id, String name, String code, CompanyRef company, SubModuleRef subModule,
    ...
    public static Permission create(String name, String code, CompanyRef company,
