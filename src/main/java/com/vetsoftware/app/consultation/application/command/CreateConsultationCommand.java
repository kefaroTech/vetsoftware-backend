...
public record CreateConsultationCommand(LocalDate date, Long consultationTypeId, String anamnesis,
        String diagnosis, String prognosis, LocalDate nextControl, Long animalId, Long companyId,
        BigDecimal weight, String weightUnit, BigDecimal temperature, Integer heartRate,
