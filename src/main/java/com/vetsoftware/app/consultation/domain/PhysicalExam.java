...
/**
 * Value object del examen físico / constantes vitales de una consulta (la "O" de SOAP). Todos los
 * campos son opcionales (una consulta puede no registrar examen). Las invariantes (rangos y
 * longitudes) viven aquí, en el dominio. Un examen "vacío" es válido.
 */
