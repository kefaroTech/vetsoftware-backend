 ...
 * de otra feature, y {@code SubscriptionPaymentQueryPort} es el unico punto que
 * conoce la otra rodaja.
 *
 * <p>
 ...
 *
 * <p>
 * {@code receivedAt} es el inicio del plazo de retracto; ver
 * {@code PaymentRefund}.
 *
 * <p>
...
public record SubscriptionPaymentRef(Long id, Long companyId, BigDecimal amount,
    ...
    public SubscriptionPaymentRef {
        ...
        if (receivedAt == null)
            throw new IllegalArgumentException("payment receivedAt is required");
    }
}
