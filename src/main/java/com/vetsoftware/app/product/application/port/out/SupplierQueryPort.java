 ...
 * proveedor pertenezca a la empresa (scoped) en una sola query. Único cruce permitido: el adapter en
 * {@code infrastructure/persistence} consulta el {@code SupplierJpaRepository} de la otra feature.
 */
