...
/**
 * Outbound port hacia la feature {@code supplier}: carga el companion VO {@link SupplierRef}
 * validando que el proveedor pertenezca a la empresa (scoped) en una sola query. Único cruce
 * permitido: el adapter en {@code infrastructure/persistence} consulta el {@code
