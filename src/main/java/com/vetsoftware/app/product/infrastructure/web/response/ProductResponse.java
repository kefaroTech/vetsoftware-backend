...
public record ProductResponse(Long id, String name, String code, BigDecimal salePrice,
        String baseUnitMeasureCode, String provider, SupplierSummary supplier,
        TaxTreatment taxTreatment, String notes, ProductCategorySummary productCategory,
        TaxSummary tax, CompanySummary company, LocalDateTime createdDate,
