...
public class EmployeeRoleJpaMapper {
  ...
  public EmployeeRoleJpaEntity toJpa(
      EmployeeRole employeeRole, EmployeeJpaEntity employee, RoleJpaEntity role) {
  ...
  public EmployeeRole toDomain(
      EmployeeRoleJpaEntity entity, EmployeeRef employeeRef, RoleRef roleRef) {
    return new EmployeeRole(
        entity.getId(), employeeRef, roleRef, entity.getCreatedDate(), entity.isEnabled());
  }
}
