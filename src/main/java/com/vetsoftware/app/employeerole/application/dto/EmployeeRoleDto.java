...
public record EmployeeRoleDto(Long id, EmployeeSummaryDto employee, RoleSummaryDto role,
        LocalDateTime createdDate, boolean enabled) {
    public static EmployeeRoleDto from(EmployeeRole employeeRole) {
        return new EmployeeRoleDto(employeeRole.getId(),
                EmployeeSummaryDto.from(employeeRole.getEmployee()),
                RoleSummaryDto.from(employeeRole.getRole()), employeeRole.getCreatedDate(),
