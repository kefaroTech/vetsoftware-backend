...
public class ServiceChargeOpenAccountController {
  ...
  public ServiceChargeOpenAccountController(
      CreateServiceChargeOpenAccountUseCase createUseCase,
  ...
  @PutMapping("/{id}")
  public ServiceChargeOpenAccountResponse update(
      @PathVariable Long id, @Valid @RequestBody UpdateServiceChargeOpenAccountRequest request) {
    return toResponse(
