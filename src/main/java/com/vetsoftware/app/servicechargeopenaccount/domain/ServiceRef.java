...
/**
 * Companion VO del servicio del catálogo. Incluye el impuesto del catálogo
 * ({@code hasTax} + {@code
 * tax}) para que el cargo congele el desglose tributario al crearse. El precio
 * ({@code price}) se interpreta CON IVA incluido.
 */
public record ServiceRef(Long id, String name, BigDecimal price, boolean hasTax, TaxRef tax,
    ...
    /**
     * Compat: servicio sin información de impuesto (lectura / casos sin catálogo de
     * impuesto).
     */
