...
public class ServiceChargeOpenAccount {
  ...
  /**
   * Esquema tributario congelado del catálogo: "IVA" o "INC"; null si el servicio no aplica
   * impuesto.
   */
  ...
  public ServiceChargeOpenAccount(
      Long id,
      AnimalRef animal,
      ServiceRef service,
  ...
  public static ServiceChargeOpenAccount create(
      AnimalRef animal,
      ServiceRef service,
      OpenAccountRef openAccount,
      EmployeeRef createdBy,
    ...
    BigDecimal unitPrice =
        service == null || service.price() == null ? BigDecimal.ZERO : service.price();
  ...
  private static void validate(
      AnimalRef animal, ServiceRef service, OpenAccountRef openAccount, BigDecimal unitPrice) {
