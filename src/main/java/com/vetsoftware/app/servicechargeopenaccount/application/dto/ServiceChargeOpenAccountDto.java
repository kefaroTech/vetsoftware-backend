...
public record ServiceChargeOpenAccountDto(Long id, AnimalSummaryDto animal,
        ServiceSummaryDto service, BigDecimal unitPrice, boolean hasTax, BigDecimal taxPercentage,
    ...
    public static ServiceChargeOpenAccountDto from(ServiceChargeOpenAccount charge) {
        return new ServiceChargeOpenAccountDto(charge.getId(),
                AnimalSummaryDto.from(charge.getAnimal()),
                ServiceSummaryDto.from(charge.getService()), charge.getUnitPrice(),
