...
public interface ServiceChargeOpenAccountRepository {
  ...
  /**
   * Lectura scoped a la empresa (vía la cuenta): evita IDOR cross-tenant al consultar un cargo por
   * id directo.
   */
  ...
  Optional<ServiceChargeOpenAccount> findByOpenAccountIdAndClientRequestId(
  ...
  List<ServiceChargeOpenAccount> findByOpenAccountIdAndCompanyId(
