...
public class CreateServiceChargeOpenAccountService
    implements CreateServiceChargeOpenAccountUseCase {
  ...
  public CreateServiceChargeOpenAccountService(
  ...
  public ServiceChargeOpenAccountDto execute(CreateServiceChargeOpenAccountCommand command) {
    ...
    if (command.clientRequestId() != null && !command.clientRequestId().isBlank()) {
      Optional<ServiceChargeOpenAccount> existing =
    ...
    ServiceChargeOpenAccount charge =
        ServiceChargeOpenAccount.create(
            animal, service, openAccount, createdBy, command.clientRequestId());
