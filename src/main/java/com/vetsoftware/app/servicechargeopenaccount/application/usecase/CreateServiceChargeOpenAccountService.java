...
@Observed(name = "service.charge.open.account.create")
@Service
public class CreateServiceChargeOpenAccountService
        implements
            CreateServiceChargeOpenAccountUseCase {
    ...
    public CreateServiceChargeOpenAccountService(ServiceChargeOpenAccountRepository repository,
            AnimalQueryPort animalQueryPort, ServiceQueryPort serviceQueryPort,
    ...
    public ServiceChargeOpenAccountDto execute(CreateServiceChargeOpenAccountCommand command) {
        ...
        if (command.clientRequestId() != null && !command.clientRequestId().isBlank()) {
            Optional<ServiceChargeOpenAccount> existing = repository
        ...
        ServiceRef service = serviceQueryPort
        ...
        ServiceChargeOpenAccount charge = ServiceChargeOpenAccount.create(animal, service,
