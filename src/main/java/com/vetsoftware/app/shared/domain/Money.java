 ...
 *
 * <p>
 * Es la ÚNICA excepción documentada al vertical slicing: un helper de dominio
 * PURO (sin estado, sin Spring, sin FKs a otra feature) que centraliza el
 * redondeo a escala monetaria y el desglose de la base gravable. Existe para
 * que las features de cargo (general/producto/servicio) y la facturación
 * electrónica no dupliquen la matemática del dinero. No agregar aquí lógica de
 * negocio de ninguna feature concreta: solo aritmética monetaria genérica.
 */
public final class Money {
    ...
    /**
     * Por mil sobre un monto: {@code amount · rate / 1000} (2 dec, HALF_UP). Para
     * tarifas expresadas en ‰ (p. ej. la retención de ICA: 9,66 ‰ = 0,966 %).
