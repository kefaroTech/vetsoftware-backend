...
/**
 * Invalida el cache Redis {@code employee-branch-ids} (poblado por {@code JpaBranchAccessResolver})
 * tras reasignar las sedes de un empleado. Mismo patrón que {@code EmployeeRoleCacheAdapter}: se
 * evicta DESPUÉS del commit para no borrar el cache si la transacción termina haciendo rollback.
 */
@Component
