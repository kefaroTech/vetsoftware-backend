...
public class SetEmployeeBranchesService implements SetEmployeeBranchesUseCase {
  ...
  public SetEmployeeBranchesService(
      EmployeeBranchRepository repository,
  ...
  public EmployeeBranchesDto execute(SetEmployeeBranchesCommand command) {
    ...
    // Regla: un empleado debe quedar con al menos una sede (para revocar acceso se desactiva el
    // empleado).
    if (target.isEmpty()) {
