...
public class VoidProductChargeOpenAccountService implements VoidProductChargeOpenAccountUseCase {
  ...
  public VoidProductChargeOpenAccountService(
  ...
  public ProductChargeOpenAccountDto execute(VoidProductChargeOpenAccountCommand command) {
    ...
    // Repone el inventario descontado al crear el cargo: compensa en el kardex los movimientos de
    // esta referencia
    // (idempotente). La sede/lote se toman de los movimientos originales, no hace falta
    // recalcularlos.
