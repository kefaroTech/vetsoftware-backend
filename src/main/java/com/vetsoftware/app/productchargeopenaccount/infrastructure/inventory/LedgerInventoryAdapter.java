...
/**
 * Adapter de orquestación cuenta-abierta → inventario. Es el ÚNICO punto de esta feature que conoce
 * el {@code StockLedgerUseCase} de {@code inventory}; traduce el cargo/anulación a movimientos de
 * kardex con referencia {@link StockReferenceType#OPEN_ACCOUNT_CHARGE} y el id del cargo
...
public class LedgerInventoryAdapter implements InventoryLedgerPort {
  ...
  public void recordSale(
      Long companyId, Long branchId, Long productId, int quantity, Long chargeId, Long createdBy) {
    ...
    stockLedger.recordSale(
        new RecordSaleCommand(
            ...
            productId,
            quantity,
            StockReferenceType.OPEN_ACCOUNT_CHARGE,
            chargeId,
            createdBy,
            false));
  }
