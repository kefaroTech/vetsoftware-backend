...
import com.vetsoftware.app.productchargeopenaccount.infrastructure.web.response.ProductChargeOpenAccountEmployeeSummary;
...
import com.vetsoftware.app.productchargeopenaccount.infrastructure.web.response.ProductChargeOpenAccountProductSummary;
...
public class ProductChargeOpenAccountController {
    ...
    private ProductChargeOpenAccountResponse toResponse(ProductChargeOpenAccountDto dto) {
        ...
        return new ProductChargeOpenAccountResponse(dto.id(),
                ...
                new ProductChargeOpenAccountProductSummary(p.id(), p.name(), p.code(),
                        p.salePrice()),
                dto.unitPrice(), dto.quantity(), dto.hasTax(), dto.taxPercentage(), dto.taxName(),
                dto.baseAmount(), dto.taxAmount(), dto.totalAmount(),
                new OpenAccountSummary(o.id(), o.companyId()),
                e == null ? null : new ProductChargeOpenAccountEmployeeSummary(e.id(), e.name()),
                dto.createdDate(), dto.enabled(), dto.voided(),
                v == null ? null : new ProductChargeOpenAccountEmployeeSummary(v.id(), v.name()),
