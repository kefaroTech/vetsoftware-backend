...
/**
 * Companion VO del producto del catálogo. Incluye el impuesto del catálogo ({@code hasTax} + {@code
 * tax}) para que el cargo congele el desglose tributario al crearse. El precio ({@code salePrice})
 * se interpreta CON IVA incluido.
 */
