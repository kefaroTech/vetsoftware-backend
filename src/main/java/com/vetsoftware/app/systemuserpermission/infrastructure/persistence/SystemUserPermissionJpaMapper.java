...
public class SystemUserPermissionJpaMapper {
  ...
  public SystemUserPermissionJpaEntity toJpa(
  ...
  public SystemUserPermission toDomain(SystemUserPermissionJpaEntity entity) {
    ...
    return toDomain(
        entity,
        new SystemUserRef(u.getId(), u.getCode()),
        new SystemPermissionRef(p.getId(), p.getName(), p.getCode()));
  }

  public SystemUserPermission toDomain(
      SystemUserPermissionJpaEntity entity,
      SystemUserRef systemUserRef,
      SystemPermissionRef systemPermissionRef) {
