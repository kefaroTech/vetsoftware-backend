...
public record SystemUserPermissionDto(Long id, SystemUserSummaryDto systemUser,
        SystemPermissionSummaryDto systemPermission, LocalDateTime createdDate, boolean enabled) {
    public static SystemUserPermissionDto from(SystemUserPermission systemUserPermission) {
        return new SystemUserPermissionDto(systemUserPermission.getId(),
                ...
                systemUserPermission.getCreatedDate(), systemUserPermission.isEnabled());
    }
}
